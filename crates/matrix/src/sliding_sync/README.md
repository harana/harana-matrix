...
```rust,no_run
# use matrix::{Client, sliding_sync::Version};
# use url::Url;
# async {
...
```rust
# use matrix::sliding_sync::{SlidingSyncList, SlidingSyncMode};
...
the [`BaseClient`][`base::BaseClient`] as in previous sync. This
...
```rust,no_run
use matrix::{Client, sliding_sync::{SlidingSyncList, SlidingSyncMode, Version}};
