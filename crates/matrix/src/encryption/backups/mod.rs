...
use base::crypto::olm::ExportedRoomKey;
...
impl Backups {
    ...
    ///
    /// ```no_run
    /// # use matrix::{Client, encryption::backups::BackupState};
    /// # use url::Url;
    /// # async {
    ...
    ///
    /// ```no_run
    /// # use matrix::{Client, encryption::backups::UploadState};
    /// # use url::Url;
    /// # async {
    /// # let homeserver = Url::parse("http://example.com")?;
    /// # let client = Client::new(homeserver).await?;
...
mod test {
    ...
    async fn test_resuming_backups_when_keys_are_inconsistent_has_no_effect() {
        ...
        // matrix::encryption::backups::Backups::maybe_enable_backups, and
    ...
    async fn test_the_done_of_an_earlier_upload_does_not_end_the_wait() {
        ...
        let result = sdk_common::timeout::timeout(
    ...
    async fn test_waiting_for_steady_state_resets_the_delay() {
        ...
        let task = sdk_common::executor::spawn({
