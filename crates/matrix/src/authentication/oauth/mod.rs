...
impl OAuth {
    ...
    ///
    /// ```no_run
    /// use matrix::{Client, ServerName};
    /// # use matrix::authentication::oauth::ClientId;
    /// # use matrix::authentication::oauth::registration::ClientMetadata;
    /// # use ruma::serde::Raw;
    ...
    async fn exchange_device_code(
        ...
        let response = OAuthClient::new(client_id)
            ...
            .request_async(self.http_client(), sdk_common::sleep::sleep, None)
            .await?;
