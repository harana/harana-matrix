...
//
// Ported from tuwunel `src/core/utils/stream/try_wideband.rs`.

//! Concurrent, order-preserving combinators for `futures_util::TryStream`.
    ...
    E: Send,
{
    ...
    where
        ...
        U: Send,
    {
        self.map_ok(f).try_buffered(n.into().unwrap_or_else(automatic_width))
    }
}
