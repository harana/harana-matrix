...
#[cfg(feature = "event-cache-store")]
use client_base::event_cache::store::EventCacheStoreError;
#[cfg(feature = "media-store")]
use client_base::media::store::MediaStoreError;
#[cfg(feature = "state-store")]
use client_base::store::StoreError as StateStoreError;
...
pub enum OpenStoreError {
    ...
    InitCipher(#[from] client_store_encryption::Error),
...
pub enum Error {
    ...
    #[error(transparent)]
    Codec(#[from] client_store_encryption::CodecError),

    #[error(transparent)]
    Encryption(client_store_encryption::Error),
...
impl_from!(client_store_encryption::Error => Error::Encryption);
