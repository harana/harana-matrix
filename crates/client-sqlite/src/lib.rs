...
use client_store_encryption::{StoreCipherProvider, StoreCodec};
...
/// [`client_store_encryption`] directly.
pub mod pluggable {
    pub use client_store_encryption::{
