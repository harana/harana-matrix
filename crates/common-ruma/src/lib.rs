...
//! | `ruma-events`          | `common-events`        | [`events`]           |
//! | `ruma-client-api`      | `common-client-api`    | [`api::client`]      |
//! | `ruma-federation-api`  | `common-federation-api`| `api::federation`    |
//! | `ruma-appservice-api`  | `common-appservice-api`| [`api::appservice`]  |
//! | `ruma-html`            | `common-html`          | `html`               |
//! | `ruma-signatures`      | `common-signatures`    | `signatures`         |
//! | `ruma-state-res`       | `common-state-res`     | [`state_res`]        |
//!
...
#[doc(inline)]
pub use ::common_events as events;
#[cfg(feature = "html")]
#[doc(inline)]
pub use ::common_html as html;
#[cfg(feature = "signatures")]
#[doc(inline)]
pub use ::common_signatures as signatures;
#[cfg(feature = "state-res")]
#[doc(inline)]
pub use ::common_state_res as state_res;
...
pub mod api {
    pub use common_types::api::*;

    #[cfg(feature = "appservice-api")]
    #[doc(inline)]
    pub use ::common_appservice_api as appservice;
    #[cfg(any(feature = "client", feature = "server"))]
    #[doc(inline)]
    pub use ::common_client_api as client;
    #[cfg(all(feature = "federation-api", any(feature = "client", feature = "server")))]
    #[doc(inline)]
    pub use ::common_federation_api as federation;
}
