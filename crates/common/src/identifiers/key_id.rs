...
///
/// ```
/// use harana_matrix_common::DeviceKeyId;
///
...
///
/// ```
/// use harana_matrix_common::{DeviceKeyAlgorithm, DeviceKeyId};
///
...
#[derive(IdDst)]
#[ruma_id(
    validate = harana_matrix_common::validation::key_id::validate::<K>,
)]
...
impl<A: KeyAlgorithm, K: KeyName + ?Sized> KeyId<A, K> {
    ...
    ///
    /// ```
    /// use harana_matrix_common::{DeviceKeyId, device_id};
    ///
...
mod tests {
    ...
    use harana_matrix_common::validation::Error;
