...
//!
//! - [MSC1767][]: Text messages, where the `m.message` primary type replaces
//!   the `m.text` message type.
//! - [MSC3954][]: Emotes, where the `m.emote` primary type replaces the
//!   `m.emote` message type.
//! - [MSC3955][]: Automated events, where the `m.automated` mixin replaces the
//!   `m.notice` message type.
//! - [MSC3956][]: Encrypted events, where the `m.encrypted` primary type
//!   replaces the `m.room.encrypted` primary type.
//! - [MSC3551][]: Files, where the `m.file` primary type replaces the `m.file`
//!   message type.
//! - [MSC3552][]: Images and Stickers, where the `m.image` primary type
//!   replaces the `m.image` message type and the `m.sticker` primary type.
//! - [MSC3553][]: Videos, where the `m.video` primary type replaces the
//!   `m.video` message type.
//! - [MSC3927][]: Audio, where the `m.audio` primary type replaces the
//!   `m.audio` message type.
...
//! `ruma` crate, that will enable all the MSCs for the extensible events that
