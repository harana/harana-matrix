...
use crate::events::{EmptyStateKey, PossiblyRedactedStateEventContent, StateEventType};
...
impl RoomRetentionEventContent {
    ...
    /// # use harana_matrix_common::events::room::retention::RoomRetentionEventContent;
    /// # fn doctest() -> Option<()> {
...
mod tests {
    ...
    use super::*;
    use crate::{__ruma::canonical_json::assert_to_canonical_json_eq, events::OriginalStateEvent};
