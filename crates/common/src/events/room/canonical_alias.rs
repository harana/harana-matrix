...
use crate::{__ruma::OwnedRoomAliasId, events::EmptyStateKey};
...
pub struct RoomCanonicalAliasEventContent {
    ...
    #[serde(
        default,
        deserialize_with = "crate::__ruma::serde::empty_string_as_none",
...
mod tests {
    ...
    use crate::{
        __ruma::{canonical_json::assert_to_canonical_json_eq, owned_room_alias_id},
