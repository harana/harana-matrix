...
use crate::events::room::{EncryptedFile, OwnedMxcUri, UInt};
...
mod tests {
    ...
    use assign::assign;
    use js_int::uint;
    use crate::__ruma::{canonical_json::assert_to_canonical_json_eq, owned_mxc_uri};
    ...
    fn serialize_extensible_room_message_with_preview() {
        use crate::events::message::MessageEventContent;
