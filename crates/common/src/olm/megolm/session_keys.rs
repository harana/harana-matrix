...
use crate::olm::{Ed25519PublicKey, Ed25519Signature, SignatureError};
...
pub enum SessionKeyDecodeError {
    ...
    PublicKey(#[from] crate::olm::KeyError),
}
...
#[cfg(test)]
mod test {
    use crate::olm::megolm::{ExportedSessionKey, GroupSession, InboundGroupSession, SessionKey};
