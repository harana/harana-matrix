...
//! ```
//! use anyhow::Result;
//! use harana_matrix_common::olm::olm::{
//!     Account, InboundCreationResult, OlmMessage, SessionConfig,
//! };
//!
//! fn main() -> Result<()> {
...
//!
//!         let what_alice_received =
//!             alice_session.decrypt(&bob_encrypted_reply)?;
