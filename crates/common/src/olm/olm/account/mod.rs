...
impl Account {
    ...
    pub fn from_libolm_pickle(
        ...
        use crate::olm::utilities::unpickle_libolm;
    ...
    pub fn to_dehydrated_device(
        &self,
        key: &[u8; 32],
    ) -> Result<DehydratedDeviceResult, crate::olm::DehydratedDeviceError> {
        use matrix_pickle::Encode;

        use self::dehydrated_device::Pickle;
        use crate::olm::{DehydratedDeviceError, LibolmPickleError, utilities::base64_encode};
    ...
    pub fn from_dehydrated_device(
        ...
        nonce: &str,
        key: &[u8; 32],
    ) -> Result<Self, crate::olm::DehydratedDeviceError> {
        use self::dehydrated_device::PICKLE_VERSION;
        use crate::olm::utilities::{base64_decode, get_pickle_version};
        ...
        if nonce.len() != 12 {
            Err(crate::olm::DehydratedDeviceError::InvalidNonce)
        } else {
            ...
            let version = get_pickle_version(&plaintext)
                .ok_or(crate::olm::DehydratedDeviceError::MissingVersion)?;

            if version != PICKLE_VERSION {
                Err(crate::olm::DehydratedDeviceError::Version(PICKLE_VERSION, version))
            } else {
    ...
    pub fn from_decrypted_dehydrated_device(
        ...
        use self::dehydrated_device::Pickle;
        use crate::olm::{DehydratedDeviceError, LibolmPickleError};
...
mod libolm {
    ...
    impl TryFrom<Pickle> for Account {
        type Error = crate::olm::LibolmPickleError;
...
mod test {
    ...
    fn fuzz_corpus_unpickling() {
        crate::olm::run_corpus("olm-account-unpickling", |data| {
    ...
    fn libolm_pickle_cycle() -> Result<()> {
        ...
        let olm_signature = crate::olm::types::Ed25519Signature::from_base64(&olm_signature)
