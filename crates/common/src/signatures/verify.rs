...
/// # use harana_matrix_common::RoomVersionId;
/// # use harana_matrix_common::serde::Base64;
/// # use harana_matrix_common::signatures::{verify_event, Verified};
/// #
...
///
/// // Verify at least one signature for each entity in `public_key_map`.
/// assert!(harana_matrix_common::signatures::verify_json(&public_key_map, &object).is_ok());
/// ```
pub fn verify_json(
    public_key_map: &PublicKeyMap,
    object: &CanonicalJsonObject,
...
///
/// ```
/// use harana_matrix_common::signatures::to_canonical_json_string_for_signing;
///
/// let input = r#"{
///     "本": 2,
///     "日": 1
