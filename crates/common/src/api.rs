...
/// ```
/// pub mod do_a_thing {
///     use ruma::{OwnedRoomId, api::request};
///     # use ruma::{api::{auth_scheme::NoAuthentication, response}, metadata};
///
///     // metadata! { ... };
///     # metadata! {
///     #     method: POST,
...
/// ```
/// pub mod do_a_thing {
///     use ruma::{OwnedRoomId, api::response};
///     # use ruma::{api::{auth_scheme::NoAuthentication, request}, metadata};
///
///     // metadata! { ... };
///     # metadata! {
///     #     method: POST,
