...
/// ```
/// pub mod do_a_thing {
///     use harana_matrix_common::{OwnedRoomId, api::request};
///     # use harana_matrix_common::{api::{auth_scheme::NoAuthentication, response}, metadata};
///
///     // metadata! { ... };
///     # metadata! {
///     #     method: POST,
...
///     use harana_matrix_common::api::request;
///     # use harana_matrix_common::{api::{auth_scheme::NoAuthentication, response}, metadata};
///
///     // metadata! { ... };
///     # metadata! {
...
/// ```
/// pub mod do_a_thing {
///     use harana_matrix_common::{OwnedRoomId, api::response};
///     # use harana_matrix_common::{api::{auth_scheme::NoAuthentication, request}, metadata};
///
///     // metadata! { ... };
///     # metadata! {
///     #     method: POST,
...
///     use http::header::CONTENT_TYPE;
///     use harana_matrix_common::api::response;
///     # use harana_matrix_common::{api::{auth_scheme::NoAuthentication, request}, metadata};
///
///     // metadata! { ... };
///     # metadata! {
