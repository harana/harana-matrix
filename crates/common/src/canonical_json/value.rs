...
pub enum CanonicalJsonValue {
    ...
    /// ```
    /// # use serde_json::json;
    /// # use harana_matrix_common::CanonicalJsonValue;
    ...
    fn try_from(val: JsonValue) -> Result<Self, Self::Error> {
        Ok(match val {
            ...
            JsonValue::Number(num) => {
                ...
                //
                // We do several checks because the docs say that `num.is_f64()` is not
                // guaranteed to return `false` for an integer in the future.
