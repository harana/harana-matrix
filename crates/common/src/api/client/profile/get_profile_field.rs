...
pub mod v3 {
    ...
    //! [`get_display_name`]: crate::api::client::profile::get_display_name
    ...
    impl crate::__ruma::api::OutgoingRequest for Request {
        ...
        fn try_into_http_request_inner(
            ...
            use crate::{
                __ruma::api::path_builder::PathBuilder,
                api::client::profile::field_existed_before_extended_profiles,
            };
            ...
            let url = if field_existed_before_extended_profiles(&self.field) {
                ...
                crate::api::client::profile::EXTENDED_PROFILE_FIELD_HISTORY.make_endpoint_url(
                    considering,
                    base_url,
    ...
    #[cfg(feature = "client")]
    impl<F: StaticProfileField> crate::__ruma::api::OutgoingRequest for RequestStatic<F> {
        type Body = EmptyBody;
        type EndpointError = Error;
    ...
    #[doc(hidden)]
    #[derive(crate::__ruma::serde::_FakeDeriveSerde)]
    #[cfg_attr(feature = "server", derive(crate::__ruma::api::OutgoingBodyJson))]
    #[serde(transparent)]
    ...
    impl<'de> serde::Deserialize<'de> for ResponseBody {
        ...
        {
            use crate::__ruma::profile::ProfileFieldValueVisitor;
    ...
    impl crate::__ruma::api::OutgoingResponse for Response {
        ...
        fn try_into_http_response_inner(
            ...
            Ok(http::Response::builder()
                ...
                .header(http::header::CONTENT_TYPE, crate::__ruma::http_headers::APPLICATION_JSON)
    ...
    #[cfg(feature = "client")]
    impl<F: StaticProfileField> crate::__ruma::api::IncomingResponse for ResponseStatic<F> {
        type EndpointError = Error;
        ...
        fn try_from_http_response_inner(
            ...
            use crate::api::client::profile::profile_field_serde::StaticProfileFieldVisitor;
...
mod tests_client {
    ...
    fn get_static_response<R: crate::__ruma::api::OutgoingRequest>(
        value: Option<ProfileFieldValue>,
    ) -> Result<
        R::IncomingResponse,
        crate::__ruma::api::error::FromHttpResponseError<R::EndpointError>,
    > {
        use crate::__ruma::api::IncomingResponseExt as _;
    ...
    fn static_request_and_valid_response() {
        use crate::api::client::profile::AvatarUrl;
...
mod tests_server {
    ...
    fn serialize_response() {
        use crate::__ruma::api::OutgoingResponseExt;
