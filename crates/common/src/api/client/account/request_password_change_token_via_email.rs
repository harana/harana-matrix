...
pub mod v3 {
    ...
    use crate::{
        ...
        api::client::account::IdentityServerInfo,
    };
    ...
    /// Response type for the `request_password_change_token_via_email`
    /// endpoint.
    #[response]
    pub struct Response {
    ...
    impl Request {
        /// Creates a new `Request` with the given client secret, email address
        /// and send-attempt counter.
        #[allow(deprecated)]
