...
use crate::__ruma::events::{AnySyncStateEvent, AnySyncTimelineEvent, StateEventType};
...
pub mod request {
    use crate::__ruma::{RoomId, directory::RoomTypeFilter, serde::deserialize_cow_str};
    ...
    pub struct Profiles {
        ...
        #[serde(skip_serializing_if = "Option::is_none")]
        pub fields: Option<Vec<crate::__ruma::profile::ProfileFieldName>>,
    }
...
pub mod response {
    use crate::__ruma::OneTimeKeyAlgorithm;
    #[cfg(feature = "unstable-msc4308")]
    use crate::__ruma::OwnedEventId;
    #[cfg(feature = "unstable-msc4262")]
    use crate::__ruma::profile::UserProfileUpdate;
    ...
    pub struct Room {
        ...
        #[cfg_attr(
            ...
            serde(default, deserialize_with = "crate::__ruma::serde::default_on_error")
        )]
        ...
        #[cfg_attr(
            feature = "unstable-compat-lax-syncv5-deser",
            serde(deserialize_with = "crate::__ruma::serde::default_on_error")
        )]
...
mod tests {
    ...
    fn sticky_events_extension_serde() {
        use crate::__ruma::assert_to_canonical_json_eq;
