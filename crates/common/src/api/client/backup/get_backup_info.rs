...
pub mod v3 {
    ...
    #[derive(Deserialize)]
    pub(in crate::api::client::backup) struct ResponseBodyRepr {
    ...
    #[derive(Serialize)]
    pub(in crate::api::client::backup) struct RefResponseBodyRepr<'a> {
    ...
    pub(in crate::api::client::backup) struct AlgorithmWithData {
        pub algorithm: Box<RawJsonValue>,
        pub auth_data: Box<RawJsonValue>,
    }
