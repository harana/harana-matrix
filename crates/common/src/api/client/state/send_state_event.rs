...
pub mod v3 {
    ...
    use crate::__ruma::events::sticky::StickyDurationMs;
    ...
    impl crate::__ruma::api::IncomingRequest for Request {
            ...
            S: AsRef<str>,
        {
            ...
            let body: Raw<AnyStateEventContent> = crate::__ruma::serde::deserialize_raw_object(
...
mod tests {
    ...
    use crate::__ruma::events::{EmptyStateKey, room::name::RoomNameEventContent};
