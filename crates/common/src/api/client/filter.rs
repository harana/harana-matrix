...
use js_int::UInt;
use crate::__ruma::{OwnedRoomId, OwnedUserId, serde::StringEnum};
...
pub struct RoomEventFilter {
    ...
    /// [`sync_events`]: crate::api::client::sync::sync_events
...
pub struct RoomFilter {
    ...
    #[serde(default, skip_serializing_if = "crate::__ruma::serde::is_empty")]
...
macro_rules! can_be_empty {
    ($ty:ident) => {
        impl crate::__ruma::serde::CanBeEmpty for $ty {
