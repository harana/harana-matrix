...
pub mod unstable {
    ...
    use crate::__ruma::events::room::retention::{RoomRetentionEventContent, is_valid_lifetime_combination};
    ...
    impl LifetimeLimits {
        ...
        /// # use harana_matrix_common::api::client::retention::get_retention_configuration::unstable::LifetimeLimits;
        /// # fn doctest() -> Option<()> {
