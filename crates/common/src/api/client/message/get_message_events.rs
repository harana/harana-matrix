...
pub mod v3 {
    ...
    pub struct Request {
        ...
        #[ruma_api(query)]
        #[serde(
            with = "crate::__ruma::serde::json_string",
            default,
    ...
    impl Request {
        ...
        ///
        /// ```rust
        /// # use harana_matrix_common::api::client::message::get_message_events;
        /// # let room_id = harana_matrix_common::owned_room_id!("!a:example.org");
