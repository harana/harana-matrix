...
pub mod v3 {
    ...
    pub struct Request {
        ...
        #[ruma_api(body)]
        #[serde(deserialize_with = "crate::__ruma::serde::deserialize_raw_object")]
...
mod tests {
    ...
    use crate::__ruma::events::{MessageLikeEventType, sticky::StickyDurationMs};
    use serde_json::json;
    ...
    fn test_sticky_send_message_request() {
        ...
        let mut request = crate::api::client::message::send_message_event::v3::Request::new_raw(
