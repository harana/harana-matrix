...
use crate::__ruma::events::{AnyToDeviceEventContent, ToDeviceEventType, receipt::Receipt};
...
impl PresenceRecipientListUpdates {
    ...
    /// Checks if the recipient list updates are empty.
...
mod tests {
    ...
    use crate::__ruma::events::ToDeviceEventType;
    use serde_json::json;
    ...
    fn msc4495_presence_edu() {
        ...
        use crate::api::federation::transactions::edu::PresenceRecipientListUpdates;
