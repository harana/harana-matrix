...
#[cfg(feature = "server")]
use crate::__ruma::api::OutgoingBody;
#[cfg(feature = "client")]
use crate::__ruma::api::error::HeaderDeserializationError;
use crate::__ruma::http_headers::ContentDisposition;
...
impl ResponseBody {
    ...
    fn try_into_http_response(
        self,
    ) -> Result<http::Response<Self>, crate::__ruma::api::error::IntoHttpError> {
...
impl ResponseBody {
    ...
    fn try_from_http_response(
        ...
        use crate::__ruma::api::error::MultipartMixedDeserializationError;
...
) -> Result<(&[u8], &[u8]), crate::__ruma::api::error::MultipartMixedDeserializationError> {
    use crate::__ruma::api::error::MultipartMixedDeserializationError;
