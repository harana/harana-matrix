...
///
/// ```
/// harana_matrix_common::priv_owned_str!();
/// ```
///
...
macro_rules! priv_owned_str {
    () => {
        ...
        pub struct PrivOwnedStr(pub std::boxed::Box<std::primitive::str>);
    ...
    ( @keyword uniffi ) => {
        ...
        #[doc(hidden)]
        pub struct PrivateString(pub std::boxed::Box<std::primitive::str>);
