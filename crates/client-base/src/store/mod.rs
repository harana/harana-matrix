...
use client_common::{cross_process_lock::CrossProcessLockConfig, locks::Mutex as SyncMutex};
...
/// # use client_base::store::StoreConfig;
/// #
...
impl StoreConfig {
    ...
    pub fn new(cross_process_lock_config: CrossProcessLockConfig) -> Self {
        Self {
            #[cfg(feature = "e2e-encryption")]
            crypto_store: client_crypto::store::MemoryStore::new().into_crypto_store(),
