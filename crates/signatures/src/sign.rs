...
///
/// ```rust
/// # use ruma::{RoomVersionId, serde::base64::Base64};
/// # use ruma::signatures::{hash_and_sign_event, Ed25519KeyPair};
/// #
/// const PKCS8: &str = "\
...
/// use ruma::signatures::sign_event;
...
/// # let key_pair = ruma::signatures::Ed25519KeyPair::from_der(
/// #    der.as_bytes(),
/// #    "1".into(), // The "version" of the key.
/// # )?;
/// # let room_version_rules = || { ruma::room_version_rules::RoomVersionRules::V6 };
///
/// // Deserialize an event from JSON.
