...
use client_base::store::StoreError;
use thiserror::Error;
...
impl IndexeddbStores {
    ...
    ///
    /// [1]: client_store_encryption::StoreCipher
    pub async fn open(
        name: &str,
