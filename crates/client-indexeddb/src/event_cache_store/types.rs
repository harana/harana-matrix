...
/// Representation of a [`Chunk`](client_base::linked_chunk::Chunk)
...
pub struct Chunk {
    ...
    /// [`ChunkIdentifier`](client_base::linked_chunk::ChunkIdentifier).
    pub identifier: u64,
...
/// [`Event`](client_base::event_cache::Event) which can be stored in
/// IndexedDB.
///
...
/// A representation of [`Position`](client_base::linked_chunk::Position)
/// which can be stored in IndexedDB.
...
impl From<Position> for client_base::linked_chunk::Position {
    fn from(value: Position) -> Self {
        Self::new(ChunkIdentifier::new(value.chunk_identifier), value.index)
    }
}

impl From<client_base::linked_chunk::Position> for Position {
    fn from(value: client_base::linked_chunk::Position) -> Self {
        Self { chunk_identifier: value.chunk_identifier().index(), index: value.index() }
    }
}

/// A representation of [`Gap`](client_base::linked_chunk::Gap)
/// which can be stored in IndexedDB.
#[derive(Debug, Serialize, Deserialize)]
pub struct Gap {
