...
pub enum Filter {
    ...
    #[serde(with = "crate::__ruma::serde::json_string")]
...
mod tests {
    ...
    fn joined_room_sticky_section_serde() {
        ...
        use crate::__ruma::events::{AnySyncMessageLikeEvent, AnySyncTimelineEvent, SyncMessageLikeEvent};
...
mod client_tests {
    ...
    use crate::__ruma::events::AnyStrippedStateEvent;
...
mod server_tests {
    ...
    use crate::__ruma::events::{AnyStrippedStateEvent, AnySyncStateEvent};
