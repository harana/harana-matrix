...
use crate::events::room::message::FormattedBody;

/// Computes the caption of a media file as defined by the [spec](https://spec.matrix.org/v1.19/client-server-api/#media-captions).
///
/// In short, this is the `body` field if the `filename` field exists and has a
/// different value, otherwise the media file does not have a caption.
...
///
/// This is the same as `caption`, but returns the formatted body instead of the
/// plain body.
