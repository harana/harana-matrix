...
pub mod v3 {
    ...
    use crate::{
        ...
        api::{
            auth_scheme::AppserviceTokenOptional, client::uiaa::UserIdentifier, request, response,
        },
        metadata,
        serde::JsonObject,
    };
    ...
    mod tests {
        ...
        use crate::{
            api::client::uiaa::UserIdentifier, canonical_json::assert_to_canonical_json_eq,
        };
        ...
        fn serialize_login_request_body() {
            ...
            use crate::api::{
                ...
                client::uiaa::{EmailUserIdentifier, UserIdentifier},
            };
