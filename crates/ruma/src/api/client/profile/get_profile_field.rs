...
pub mod v3 {
    ...
    #[cfg(feature = "client")]
    impl<F: StaticProfileField> crate::api::OutgoingRequest for RequestStatic<F> {
        type Body = EmptyBody;
        type EndpointError = Error;
    ...
    #[doc(hidden)]
    #[derive(crate::serde::_FakeDeriveSerde)]
    #[cfg_attr(feature = "server", derive(crate::api::OutgoingBodyJson))]
    #[serde(transparent)]
    ...
    impl<'de> serde::Deserialize<'de> for ResponseBody {
        ...
        {
            use crate::profile::ProfileFieldValueVisitor;
    ...
    impl crate::api::OutgoingResponse for Response {
        ...
        fn try_into_http_response_inner(
            self,
        ) -> Result<http::Response<Self::Body>, crate::api::error::IntoHttpError> {
    ...
    #[cfg(feature = "client")]
    impl<F: StaticProfileField> crate::api::IncomingResponse for ResponseStatic<F> {
        type EndpointError = Error;
...
mod tests_server {
    ...
    fn serialize_response() {
        use crate::api::OutgoingResponseExt;
