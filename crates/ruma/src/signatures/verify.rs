...
/// # use ruma::signatures::{verify_event, Verified};
/// #
...
///
/// // Verify at least one signature for each entity in `public_key_map`.
/// assert!(ruma::signatures::verify_json(&public_key_map, &object).is_ok());
/// ```
pub fn verify_json(
    public_key_map: &PublicKeyMap,
    object: &CanonicalJsonObject,
...
///
/// ```
/// use ruma::signatures::to_canonical_json_string_for_signing;
///
/// let input = r#"{
///     "本": 2,
///     "日": 1
