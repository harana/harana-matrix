...
//! # Event helper types
//!
//! The types from [`crate::events`] use strict deserialization rules according
//! to their definition in the specification, which means that they also
//! validate fields that are not checked when receiving a PDU. Since it is not
...
//! unvalidated fields.
//!
//! The types from [`crate::events`] are still appropriate to be used to create
//! a new event, or to validate an event received from a client.
//!
