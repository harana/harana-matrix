...
//! # Event helper types
//!
//! The event content types from [`crate::events`] use strict deserialization rules according to their definition in
...
//!
//! The event content types from [`crate::events`] are still appropriate to be used to create a new event, or to
