...
//! # Event helper types
//!
//! The types in [`crate::events`] use strict deserialization rules according to
...
//! module provides helper types in the [`events`] module, built around the
...
//! unvalidated fields.
//!
//! The types in [`crate::events`] are still appropriate to be used to create a
//! new event, or to validate an event received from a client.
//!
