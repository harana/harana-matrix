...
use crate::__ruma::signatures::verify_canonical_json_bytes;
use tracing::debug;
...
///
/// This assumes that `crate::__ruma::signatures::verify_event()` was called previously, as some authorization
...
pub(super) fn check_room_member<E: Event>(
    ...
    // These checks are done `in crate::__ruma::signatures::verify_event()`:
    //
