...
pub struct RoomCreateEventContent {
    ...
    #[serde(
        rename = "m.federate",
        default = "crate::__ruma::serde::default_true",
        skip_serializing_if = "crate::__ruma::serde::is_true"
    )]
    pub federate: bool,
...
mod tests {
    ...
    use crate::__ruma::{RoomVersionId, canonical_json::assert_to_canonical_json_eq, owned_user_id};
