...
//! lives at `common_ruma::events::room::message::RoomMessageEvent`. Each type's module
...
//! `common_ruma::api::client::state::send_state_event`'s `Request`.
//!
...
//! use common_ruma::events::{macros::EventContent, OriginalSyncMessageLikeEvent};
//! use serde::{Deserialize, Serialize};
//!
...
extern crate self as common_events;
...
use crate::__ruma::{EventEncryptionAlgorithm, OwnedUserId, room_version_rules::RedactionRules};
