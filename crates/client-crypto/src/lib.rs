...
use client_common::deserialized_responses::{DecryptedRoomEvent, UnableToDecryptInfo};
#[cfg(feature = "qrcode")]
pub use client_qrcode as qrcode;
...
/// # use std::collections::BTreeMap;
/// # use anyhow::Result;
/// # use client_crypto::{OlmMachine, DecryptionSettings, TrustRequirement};
/// # #[tokio::main]
/// # async fn main() -> Result<()> {
