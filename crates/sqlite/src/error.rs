...
#[cfg(feature = "event-cache-store")]
use base::event_cache::store::EventCacheStoreError;
#[cfg(feature = "media-store")]
use base::media::store::MediaStoreError;
#[cfg(feature = "state-store")]
use base::store::StoreError as StateStoreError;
...
pub enum OpenStoreError {
    ...
    InitCipher(#[from] store_encryption::Error),
...
pub enum Error {
    ...
    #[error(transparent)]
    Codec(#[from] store_encryption::CodecError),

    #[error(transparent)]
    Encryption(store_encryption::Error),
...
impl_from!(store_encryption::Error => Error::Encryption);
