...
///
/// Like [`matrix::attachment::AttachmentConfig`], but instead of the
...
pub struct AttachmentConfig {
    ...
    /// it. See [`matrix::attachment::AttachmentConfig::strip_exif`].
    pub strip_exif: bool,
...
impl Timeline {
    ...
    /// # use matrix::{Client, config::SyncSettings, ruma::room_id};
    /// # use ui::Timeline;
    /// # async {
    ...
    ///
    /// [`Media::get_media_content()`]: matrix::Media::get_media_content
    #[instrument(skip_all)]
...
///
/// This duplicates [`matrix::attachment::GalleryConfig`] but uses an
