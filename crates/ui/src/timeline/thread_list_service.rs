...
/// ```no_run
/// use matrix::Room;
/// use ui::timeline::thread_list_service::{
...
impl ThreadListService {
            ...
            .spawn_infinite_task("thread_list_service::event_cache_listener", {
                ...
                async move {
                    ...
                    let (_event_cache_drop, mut subscriber) = match async {
                        ...
                        matrix::event_cache::Result::Ok((drop_handles, subscriber))
                    }
                    .await
                    {
                        Ok(pair) => pair,
    ...
    fn collect_events_from_diffs(
        diffs: Vec<VectorDiff<base::event_cache::Event>>,
    ) -> Vec<base::event_cache::Event> {
