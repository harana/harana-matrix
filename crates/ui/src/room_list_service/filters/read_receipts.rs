...
///
/// [`ReadReceipts`]: base::read_receipts::ReadReceipts
#[cfg_attr(feature = "uniffi", derive(uniffi::Enum))]
#[cfg_attr(feature = "uniffi", uniffi(name = "RoomListFilterReadReceipts"))]
pub enum Category {
    /// Filter by mentions, i.e. [`ReadReceipts::num_mentions`].
    ///
    /// [`ReadReceipts::num_mentions`]: base::read_receipts::ReadReceipts::num_mentions
    Mentions,

    /// Filter by notifications, i.e. [`ReadReceipts::num_notifications`].
    ///
    /// [`ReadReceipts::num_notifications`]: base::read_receipts::ReadReceipts::num_notifications
    Notifications,

    /// Filter by messages, i.e. [`ReadReceipts::num_unread`].
    ///
    /// [`ReadReceipts::num_unread`]: base::read_receipts::ReadReceipts::num_unread
    Messages,
}
    ...
    async fn test_build_matches_select_the_correct_category() {
        ...
        room.inner()
            .update_room_info(|mut room_info| {
                room_info.set_read_receipts(base::read_receipts::ReadReceipts {
                    num_unread: 1,
                    num_notifications: 2,
                    num_mentions: 3,
                    ..Default::default()
