...
impl RoomListService {
    ...
    ///
    /// A [`matrix::SlidingSync`] client will be created, with a cached list
    ...
    ///   profiles
    ///
    /// [`SlidingSyncBuilder::share_pos`]: matrix::sliding_sync::SlidingSyncBuilder::share_pos
    ...
    ///
    /// [listen_to_room]: matrix::latest_events::LatestEvents::listen_to_room
    /// [`LatestEventValue`]: matrix::latest_events::LatestEventValue
