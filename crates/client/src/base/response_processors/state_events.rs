...
use super::e2ee;
use crate::base::{store::BaseStateStore, utils::RawStateEventWithKeys};
...
pub mod sync {
    ...
    #[cfg(feature = "experimental-encrypted-state-events")]
    use crate::base::response_processors::e2ee;
    use crate::base::{
...
pub mod stripped {
    ...
    use crate::base::{
        RawStateEventWithKeys, Result, Room, RoomInfo, RoomInfoNotableUpdateReasons,
    };
...
async fn decrypt_state_event(
    ...
    use crate::crypto::RoomEventDecryptionResult;
