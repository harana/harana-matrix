...
use crate::common::ROOM_VERSION_RULES_FALLBACK;
...
use crate::crypto::store::{DynCryptoStore, IntoCryptoStore};
pub use crate::store_encryption::Error as StoreEncryptionError;
use crate::{
    base::{
        MinimalRoomMemberEvent, Room, RoomCreateWithCreatorEventContent, RoomStateFilter,
        SessionMeta,
    ...
    common::{cross_process_lock::CrossProcessLockConfig, locks::Mutex as SyncMutex},
};
...
/// </div>
///
/// [`BaseClient::clone_with_in_memory_state_store`]: crate::base::BaseClient::clone_with_in_memory_state_store
...
/// # use crate::base::store::StoreConfig;
/// #
...
impl StoreConfig {
    ...
    /// [`CrossProcessLock::new`](crate::common::cross_process_lock::CrossProcessLock::new).
    #[must_use]
    pub fn new(cross_process_lock_config: CrossProcessLockConfig) -> Self {
        Self {
            #[cfg(feature = "e2e-encryption")]
            crypto_store: crate::crypto::store::MemoryStore::new().into_crypto_store(),
...
mod tests {
    ...
    use crate::{
        base::{RoomInfo, RoomState, SessionMeta, StateChanges, StateStore},
        test::async_test,
    };
