...
use crate::base::media::MediaRequestParameters;
...
pub enum QueuedRequestKind {
    ...
    ///
    /// This is what
    /// [`crate::base::store::send_queue::QueuedRequestKind::ReadReceipt`] is to
    /// a single receipt, for the endpoint that sets the fully-read marker
    /// and both read receipts in one go.
    ReadMarkers {
...
/// `crate::room::reply::EnforceThread`.
