...
use crate::{base::store::SerializableEventContent, common::deserialized_responses::TimelineEvent};
...
impl LatestEventValue {
    ...
    /// [`SyncOrStrippedState::timestamp`]: crate::base::deserialized_responses::SyncOrStrippedState::timestamp
