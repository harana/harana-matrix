...
use crate::crypto::{CryptoStoreError, MegolmError, OlmError};
use crate::{
    base::{event_cache::store::EventCacheStoreError, media::store::MediaStoreError},
    common::cross_process_lock::CrossProcessLockError,
};
...
pub enum Error {
    ...
    #[error(transparent)]
    StateStore(#[from] crate::base::store::StoreError),
