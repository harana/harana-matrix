...
pub struct Room {
    ...
    ///
    /// [`BaseStateStore::room_info_notable_update_sender`]: crate::base::store::BaseStateStore::room_info_notable_update_sender
...
impl Room {
    ...
    /// in the meantime.
    ///
    /// [`BaseClient::receive_all_members`]: crate::base::BaseClient::receive_all_members
...
fn test_send_sync_for_room() {
    fn assert_send_sync<T: crate::common::SendOutsideWasm + crate::common::SyncOutsideWasm>() {}
...
mod tests {
    ...
    use super::*;
    use crate::{
        base::test_utils::logged_in_base_client,
    ...
    async fn test_room_heroes_carry_global_profile() {
        ...
        use crate::base::store::StateChanges;
