...
//! the `ui` crate, but it could be any other listener that
...
#[cfg(doc)]
use crate::base::{BaseClient, crypto::OlmMachine};
#[cfg(doc)]
use crate::common::deserialized_responses::EncryptionInfo;
use crate::{
    Client, Result, Room,
    base::{
        crypto::{
...
impl EventCache {
    ...
    ///
    /// ```no_run
    /// # use crate::{Client, event_cache::DecryptionRetryRequest};
    /// # use url::Url;
    ...
    ///
    /// ```no_run
    /// # use crate::{Client, event_cache::RedecryptorReport};
    /// # use url::Url;
...
mod tests {
    ...
    use crate::{
        ...
        base::{
            ...
            crypto::types::events::{
                ToDeviceEvent, room::encrypted::ToDeviceEncryptedEventContent,
            },
            deserialized_responses::{
        ...
        test::{ALICE, JoinedRoomBuilder, async_test, event_factory::EventFactory},
    ...
    fn test_undecryptable_bundled_locations() {
        ...
        use crate::base::deserialized_responses::{
