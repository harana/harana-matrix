...
//! ```no_run
//! # use crate::Client;
//! # use crate::base::crypto::store::types::DehydratedDeviceKey;
...
use crate::{
    ...
    client::WeakClient,
    common::{
        boxed_into_future, locks::Mutex as StdMutex, sleep::sleep,
...
impl DehydratedDevices {
    ...
    ///
    /// ```no_run
    /// # use crate::{Client, encryption::secret_storage::SecretStore};
