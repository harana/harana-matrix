...
#[cfg(feature = "experimental-encrypted-state-events")]
use crate::base::crypto::types::events::room::encrypted::{
    EncryptedEvent, RoomEventEncryptionScheme,
};
use crate::{
    Client, Room,
    base::crypto::store::types::{RoomKeyBundleInfo, RoomPendingKeyBundleDetails},
    client::WeakClient,
    common::{
...
mod test {
    ...
    use super::*;
    use crate::{test::async_test, test_utils::logged_in_client};
