...
use crate::{
    Client, Result,
    base::crypto::{CancelInfo, DeviceData, VerificationRequest as BaseVerificationRequest},
};
...
impl VerificationRequest {
    ...
    fn convert_state(
        client: Client,
        state: crate::base::crypto::VerificationRequestState,
    ) -> VerificationRequestState {
        use crate::base::crypto::VerificationRequestState::*;
