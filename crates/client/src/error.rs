...
#[cfg(feature = "qrcode")]
use crate::base::crypto::ScanError;
...
#[cfg(feature = "sqlite")]
impl From<crate::sqlite::OpenStoreError> for Error {
    fn from(error: crate::sqlite::OpenStoreError) -> Self {
        ClientBuildError::from(error).into()
    }
}

#[cfg(feature = "indexeddb")]
impl From<crate::indexeddb::OpenStoreError> for Error {
    fn from(error: crate::indexeddb::OpenStoreError) -> Self {
        ClientBuildError::from(error).into()
    }
}
...
mod tests {
    ...
    fn test_client_build_error_propagates_with_the_question_mark_operator() {
        // The point of the conversion: a function returning `crate::Error` can
    ...
    fn test_open_store_error_propagates_with_the_question_mark_operator() {
        fn open() -> Result<(), crate::sqlite::OpenStoreError> {
            Err(crate::sqlite::OpenStoreError::MissingVersion)
        }
