...
macro_rules! timer {
    ($level:expr, $string:expr $(,)? ) => {{
        ...
        $crate::common::tracing_timer::TracingTimer::new(&__CALLSITE, $string.into(), $level)
    }};
    ...
    async fn test_timer_name() {
        ...
        mod time123 {
            pub async fn run() {
                ...
                // crate::common::tracing_timer::tests: Timer _test_
                // finished in 124ms
            }
        }
        ...
        // crate::common::tracing_timer::tests: Timer _in span_ finished in
        // 257ms
    }
}
