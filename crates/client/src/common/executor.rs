...
//!
//! The runtime itself is described by [`crate::common::runtime::AsyncRuntime`];
//! this module builds the joining and cancellation the SDK needs on top of the
//! bare "spawn and forget" it provides, so the semantics are identical no
//! matter which runtime is installed.
