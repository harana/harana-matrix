...
///
/// ```
/// # use crate::common::js_tracing::MakeJsLogWriter;
...
pub(crate) mod tests {
    ...
    use crate::common::js_tracing::make_tracing_subscriber;
    ...
    async fn test_make_tracing_subscriber() -> Result<(), js_sys::Error> {
        ...
        let expected_prefix = "DEBUG crate::common::js_tracing::tests: Test message\n    value=1\n";
        assert!(
