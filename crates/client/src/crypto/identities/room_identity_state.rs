...
use crate::{common::BoxFuture, crypto::store::types::IdentityUpdates};

/// Something that can answer questions about the membership of a room and the
/// identities of users.
///
/// This is implemented by `crate::Room` and is a trait here so we can
...
pub enum IdentityState {
    ...
    /// [`crate::crypto::OtherUserIdentity::pin_current_master_key`].
    PinViolation,
