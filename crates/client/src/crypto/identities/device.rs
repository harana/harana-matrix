...
use harana_matrix_common::{
    ...
    olm::{Curve25519PublicKey, Ed25519PublicKey, olm::SessionConfig},
    serde::Raw,
};
...
pub enum LocalTrust {
    ...
    ///
    /// [`CollectStrategy`]: crate::crypto::CollectStrategy
    BlackListed = 1,
...
impl DeviceData {
    ...
    pub async fn from_machine_test_helper(
        machine: &OlmMachine,
    ) -> Result<DeviceData, crate::crypto::CryptoStoreError> {
...
pub(crate) mod testing {
    ...
    use crate::crypto::{identities::DeviceData, types::DeviceKeys};
...
pub(crate) mod tests {
    ...
    use crate::crypto::{DeviceData, identities::LocalTrust};
    ...
    async fn test_most_recent_session_is_the_last_one_that_decrypted() {
        ...
        use harana_matrix_common::{
            SecondsSinceUnixEpoch, device_id, olm::olm::SessionConfig, time::SystemTime,
        };
