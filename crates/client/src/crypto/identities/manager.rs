...
#[cfg(feature = "experimental-x509-identity-verification")]
use crate::crypto::types::requests::OutgoingRequest;
use crate::{
    common::{executor::spawn, failures_cache::FailuresCache},
    crypto::{
...
pub(crate) struct IdentityManager {
    ...
    /// `/keys/query` response.
    ///
    /// See also [`crate::crypto::session_manager::SessionManager::failures`].
...
pub(crate) mod tests {
    ...
    use crate::{
        ...
        test::{async_test, ruma_response_from_json, test_json},
    };
    ...
    async fn test_refresh_x509_signature_after_keys_query() {
        ...
        // given X.509 signer.
        let make_response = async move |x509_signer: &crate::crypto::x509::X509Signer| {
    ...
    async fn manager_with_private_identity_and_x509(
        ...
        account: Account,
        x509_signer: crate::crypto::x509::X509Signer,
    ) -> IdentityManager {
        use crate::crypto::{
            store::{
