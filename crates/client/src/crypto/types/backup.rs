...
use harana_matrix_common::{olm::Curve25519PublicKey, serde::JsonCastable};
...
impl JsonCastable<harana_matrix_common::api::client::backup::BackupAlgorithm>
    for RoomKeyBackupInfo
{
}

impl JsonCastable<RoomKeyBackupInfo>
    for harana_matrix_common::api::client::backup::BackupAlgorithm
{
}
...
mod tests {
    ...
    use harana_matrix_common::{
        DeviceKeyAlgorithm, KeyId,
        olm::{Curve25519PublicKey, Ed25519Signature},
        owned_user_id,
    };
    ...
    use crate::crypto::types::{MegolmV1AuthData, Signatures};
