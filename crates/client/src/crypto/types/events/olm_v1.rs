...
use harana_matrix_common::{OwnedUserId, UserId, olm::Ed25519PublicKey};
...
mod tests {
    ...
    use harana_matrix_common::{
        ...
        olm::{Curve25519PublicKey, Ed25519PublicKey, Ed25519Signature},
    ...
    fn sender_device_keys() -> (Value, DeviceKeys) {
        ...
        let ed25519_device_key_id =
            KeyId::from_parts(harana_matrix_common::DeviceKeyAlgorithm::Ed25519, device_id);
        let curve25519_device_key_id =
            KeyId::from_parts(harana_matrix_common::DeviceKeyAlgorithm::Curve25519, device_id);
        let ed25519_ssk_id =
            KeyId::from_parts(harana_matrix_common::DeviceKeyAlgorithm::Ed25519, ssk_id);
