...
use crate::crypto::types::events::from_str;
...
mod tests {
    ...
    fn deserialization() -> Result<(), serde_json::Error> {
        ...
        assert_serialization_roundtrip!(
            // `m.room_key
            crate::crypto::types::events::room_key::tests::json_stable => RoomKey,
            ...
            // `m.secret.send`
            crate::crypto::types::events::secret_send::tests::json => SecretSend,
            ...
            // `m.room.encrypted`
            crate::crypto::types::events::room::encrypted::tests::to_device_json => RoomEncrypted,
        );
