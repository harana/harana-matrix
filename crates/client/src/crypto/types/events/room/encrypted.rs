...
use harana_matrix_common::{
    OwnedDeviceId, RoomId,
    events::AnyToDeviceEventContent,
    olm::{Curve25519PublicKey, megolm::MegolmMessage, olm::OlmMessage},
    serde::JsonCastable,
};
...
use crate::crypto::types::{
    ...
    serde_curve_key_option, serialize_curve_key,
};
...
impl JsonCastable<harana_matrix_common::events::AnyMessageLikeEventContent>
    for RoomEncryptedEventContent
{
}

#[cfg(feature = "experimental-encrypted-state-events")]
impl JsonCastable<harana_matrix_common::events::AnyStateEventContent>
    for RoomEncryptedEventContent
{
}
