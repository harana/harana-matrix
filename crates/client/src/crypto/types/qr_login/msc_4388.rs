...
mod test {
    ...
    use super::*;
    use crate::crypto::types::qr_login::QrCodeDataInner;
    ...
    fn parse_qr_data_base64() {
        ...
        let data = crate::crypto::types::qr_login::QrCodeData::from_base64(QR_CODE_DATA_BASE64)
            .expect("We should be able to parse the QR code data");

        assert_let!(
            crate::crypto::types::qr_login::QrCodeData { inner: QrCodeDataInner::Msc4388(data) } =
                data
        );
