...
use crate::crypto::x509::raw_x509_signature::X509SignatureScheme;
#[cfg(doc)]
use crate::crypto::{types::X509Signature, x509::RawX509Signature};
...
pub enum X509SignatureSigningError {
    ...
    /// [`crate::crypto::x509::RawX509Signer`] occurred.
    #[error(transparent)]
...
pub enum X509SignatureVerificationError {
    ...
    /// A custom error specific to a particular implementation of
    /// [`crate::crypto::x509::RawX509Verifier`] occurred.
    #[error(transparent)]
    Custom(Box<dyn Error + Send + Sync>),
}
