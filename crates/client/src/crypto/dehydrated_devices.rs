...
use harana_matrix_common::{
    ...
    olm::{DehydratedDeviceError, LibolmPickleError},
    serde::Raw,
};
use thiserror::Error;
...
impl DehydratedDevices {
    ...
    pub async fn create(&self) -> Result<DehydratedDevice, DehydrationError> {
        ...
        store
            .save_pending_changes(crate::crypto::store::types::PendingChanges {
...
impl DehydratedDevice {
    ...
    /// use crate::crypto::store::types::DehydratedDeviceKey;
    ///
