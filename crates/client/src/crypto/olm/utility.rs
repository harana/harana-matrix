...
use harana_matrix_common::{
    ...
    olm::{Ed25519PublicKey, Ed25519SecretKey, Ed25519Signature, olm::Account},
};
use serde::Serialize;
...
impl SignedJsonObject for crate::crypto::types::MegolmV1AuthData {
    fn signatures(&self) -> &Signatures {
        &self.signatures
    }
}
...
mod tests {
    use harana_matrix_common::{
        DeviceKeyAlgorithm, DeviceKeyId, device_id, olm::Ed25519PublicKey, user_id,
    };
    use serde_json::json;

    use super::VerifyJson;
    use crate::crypto::types::DeviceKeys;
