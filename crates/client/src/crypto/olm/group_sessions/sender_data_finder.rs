...
use harana_matrix_common::{UserId, olm::Curve25519PublicKey};
...
/// [`crate::crypto::types::events::olm_v1::DecryptedRoomKeyEvent`].
///
/// # Algorithm
///
/// When we receive a to-device message establishing a megolm session (i.e. when
/// [`crate::crypto::machine::OlmMachine::add_room_key`] is called):
///
/// ┌───────────────────────────────────────────────────────────────────┐
...
mod tests {
    ...
    use harana_matrix_common::{
        DeviceId, OwnedUserId, RoomId, UserId, device_id,
        olm::{Curve25519PublicKey, Ed25519PublicKey, megolm::SessionKey},
        room_id, user_id,
    };
