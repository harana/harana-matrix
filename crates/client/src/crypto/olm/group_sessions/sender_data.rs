...
use harana_matrix_common::{DeviceId, OwnedDeviceId, OwnedUserId, UserId, olm::Ed25519PublicKey};
...
/// [`crate::crypto::olm::group_sessions::InboundGroupSession`]s. We want just
/// the type of the session's [`SenderData`] to be queryable, so we
...
mod tests {
    ...
    use harana_matrix_common::{
        DeviceKeyAlgorithm, DeviceKeyId, device_id,
        olm::{Curve25519PublicKey, Ed25519PublicKey, base64_decode},
