...
use crate::crypto::types::events::room::encrypted::OlmV2Curve25519AesSha2Content;
#[cfg(feature = "experimental-x509-identity-verification")]
use crate::crypto::x509::{RawX509Signer, X509Signer};
use crate::{
...
impl StaticAccountData {
    ...
    pub fn has_signed_raw(
        &self,
        signatures: &crate::crypto::types::Signatures,
        canonical_json: &str,
    ) -> Result<(), SignatureError> {
        use crate::crypto::olm::utility::VerifyJson;
...
pub type OneTimeKeys =
    BTreeMap<OwnedOneTimeKeyId, Raw<harana_matrix_common::encryption::OneTimeKey>>;
...
impl Account {
    ...
    pub fn deep_clone(&self) -> Self {
        // `harana_matrix_common::olm::Account` isn't really cloneable, but... Don't
        // tell anyone.
...
mod tests {
    ...
    async fn test_consuming_a_one_time_key_is_logged() {
        ...
        let content = as_variant::as_variant!(
            message,
            crate::crypto::types::events::room::encrypted::ToDeviceEncryptedEventContent::OlmV1Curve25519AesSha2
        )
