...
the matrix, and how to set your [`Client`] up to support E2EE.
...
The matrix represents an _end_ as a [`Device`] object. Each individual
...
_end_ is represented as a [`Device`] in the matrix. This gets rather
...
identity which is represented in the matrix using the [`UserIdentity`]
...
The matrix aims to provide encryption support transparently. If
