...
use crate::{
    ...
    ui::timeline::controller::{CryptoDropHandles, SendReceiptDecision},
};
...
pub use self::{
    ...
    event_item::{
        ...
        ReactionInfo, ReactionStatus, ReactionsByKeyBySender, RedactedMessage,
...
///
/// Like [`crate::attachment::AttachmentConfig`], but instead of the
...
pub struct AttachmentConfig {
    ...
    /// it. See [`crate::attachment::AttachmentConfig::strip_exif`].
    pub strip_exif: bool,
    /// Whether to compute the BlurHash of the image before uploading it. See
    /// [`crate::attachment::AttachmentConfig::generate_blurhash`].
...
impl Timeline {
    ...
    /// # use crate::{Client, config::SyncSettings, ruma::room_id};
    ...
    ///
    /// [`Media::get_media_content()`]: crate::Media::get_media_content
    #[instrument(skip_all)]
...
///
/// This duplicates [`crate::attachment::GalleryConfig`] but uses an
