...
pub struct InReplyToDetails {
    ...
    /// unavailable.
    ///
    /// [`Timeline::fetch_details_for_event`]: crate::ui::Timeline::fetch_details_for_event
...
impl EmbeddedEvent {
    ...
    #[instrument(skip_all)]
    pub(in crate::ui::timeline) async fn try_from_timeline_event<P: RoomDataProvider>(
