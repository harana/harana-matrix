...
pub struct PollState {
    ...
    /// polls.
    pub(in crate::ui::timeline) fallback_text: Option<String>,
    /// The poll content of the message.
    pub(in crate::ui::timeline) poll_start: UnstablePollStartContentBlock,
    pub(in crate::ui::timeline) response_data: Vec<ResponseData>,
    pub(in crate::ui::timeline) end_event_timestamp: Option<MilliSecondsSinceUnixEpoch>,
    pub(in crate::ui::timeline) has_been_edited: bool,
}

#[derive(Clone, Debug)]
pub(in crate::ui::timeline) struct ResponseData {
