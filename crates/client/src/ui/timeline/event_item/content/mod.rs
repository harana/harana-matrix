...
pub(in crate::ui::timeline) use self::{
...
impl TimelineItemContent {
    ...
    pub(in crate::ui::timeline) fn redact(
        &self,
...
#[derive(Clone, Debug)]
pub struct Sticker {
    pub(in crate::ui::timeline) content: StickerEventContent,
}
...
pub struct RoomMembershipChange {
    pub(in crate::ui::timeline) user_id: OwnedUserId,
    pub(in crate::ui::timeline) content: StateEventContentChange<RoomMemberEventContent>,
    pub(in crate::ui::timeline) change: Option<MembershipChange>,
}
...
pub struct MemberProfileChange {
    pub(in crate::ui::timeline) user_id: OwnedUserId,
    pub(in crate::ui::timeline) displayname_change: Option<Change<Option<String>>>,
    pub(in crate::ui::timeline) avatar_url_change: Option<Change<Option<OwnedMxcUri>>>,
}
...
pub struct OtherState {
    pub(in crate::ui::timeline) state_key: String,
    pub(in crate::ui::timeline) content: AnyOtherStateEventContentChange,
}
