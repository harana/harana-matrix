...
use crate::ui::DEFAULT_SANITIZER_MODE;

/// An `m.room.message` event or extensible event, including edits.
#[derive(Clone)]
pub struct Message {
    pub(in crate::ui::timeline) msgtype: MessageType,
    pub(in crate::ui::timeline) edited: bool,
    pub(in crate::ui::timeline) mentions: Option<Mentions>,
}

impl Message {
    /// Construct a `Message` from a `m.room.message` event.
    pub(in crate::ui::timeline) fn from_event(
