...
pub struct BeaconInfo {
    ...
    pub(in crate::ui::timeline) geo_uri: String,

    /// Timestamp of this location update (from the beacon event's
    /// `org.matrix.msc3488.ts` field).
    pub(in crate::ui::timeline) ts: MilliSecondsSinceUnixEpoch,

    /// An optional human-readable description of the location.
    pub(in crate::ui::timeline) description: Option<String>,
    ...
    /// unavailable).
    pub(in crate::ui::timeline) encryption_info: Option<Arc<EncryptionInfo>>,
}
...
pub struct LiveLocationState {
    ...
    pub(in crate::ui::timeline) beacon_info: BeaconInfoEventContent,

    /// All location updates aggregated onto this session, kept sorted by
    /// timestamp.
    pub(in crate::ui::timeline) locations: Vec<BeaconInfo>,
}
...
impl LiveLocationState {
    ...
    /// recent one.
    pub(in crate::ui::timeline) fn add_location(&mut self, location: BeaconInfo) {
    ...
    pub(in crate::ui::timeline) fn remove_location(&mut self, ts: MilliSecondsSinceUnixEpoch) {
    ...
    pub(in crate::ui::timeline) fn stop(&mut self, beacon_info: BeaconInfoEventContent) {
    ...
    pub(in crate::ui::timeline) fn matches_stop(&self, stop: &BeaconInfoEventContent) -> bool {
