...
pub(in crate::ui::timeline) mod aggregations;
...
use crate::base::{CallIntentConsensus, RoomInfo};
...
/// of a timeline.
#[derive(Debug)]
pub(in crate::ui::timeline) enum TimelineFocusKind {
...
/// [`crate::ui::timeline::TimelineBuilder::event_filter`].
///
...
impl<P: RoomDataProvider> TimelineController<P> {
    ...
    /// [`crate::base::RoomInfo`] and applies the new value to the
    ...
    pub(super) async fn set_sender_profiles_error(&self, error: Arc<crate::Error>) {
                ...
                if let Some(send_error) = send_error {
                    self.update_event_send_state(
                        ...
                        EventSendState::SendingFailed {
                            error: Arc::new(crate::Error::SendQueueWedgeError(Box::new(
                                send_error,
                            ))),
...
impl<P: RoomDataProvider> TimelineController<P> {
    ...
    pub(in crate::ui::timeline) async fn find_event_with_relations(
        &self,
        event_id: &EventId,
