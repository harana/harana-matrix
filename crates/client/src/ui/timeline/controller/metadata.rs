...
#[derive(Clone, Debug)]
pub(in crate::ui::timeline) struct TimelineMetadata {
    // **** CONSTANT FIELDS ****
...
impl TimelineMetadata {
    pub(in crate::ui::timeline) fn new(
    ...
    pub(in crate::ui::timeline) fn compare_events_positions(
        event_a: &EventId,
        event_b: &EventId,
...
pub(in crate::ui::timeline) enum RelativePosition {
...
#[derive(Debug, Clone)]
pub(in crate::ui::timeline) struct EventMeta {
    /// The ID of the event.
