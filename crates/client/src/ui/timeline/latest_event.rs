...
use crate::{
    Client, Room,
    base::latest_event::LatestEventValue as BaseLatestEventValue,
    latest_events::LocalLatestEventValue,
    ui::timeline::{Profile, TimelineDetails, TimelineItemContent, event_handler::TimelineAction},
};

/// A simplified version of [`crate::base::latest_event::LatestEventValue`]
