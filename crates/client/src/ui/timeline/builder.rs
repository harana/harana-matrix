...
use crate::ui::timeline::tasks::global_profile_updates_task;
use crate::{
    Room,
    base::{SendOutsideWasm, SyncOutsideWasm, ThreadingSupport},
    ui::{
        timeline::{
            TimelineReadReceiptTracking,
            controller::{ActiveCallInfo, InitFocusResult, spawn_crypto_tasks},
            tasks::{
                room_event_cache_updates_task, room_send_queue_update_task,
...
impl TimelineBuilder {
    ...
    /// [`crate::ui::timeline::default_event_filter`] so as to chain it with
...
mod tests {
    ...
    use crate::ui::timeline::{TimelineEventFocusThreadMode, TimelineFocus};
