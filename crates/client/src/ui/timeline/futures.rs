...
use crate::{TransmissionProgress, boxed_into_future, ui::timeline::AttachmentConfig};
...
impl<'a> IntoFuture for SendAttachment<'a> {
    ...
    fn into_future(self) -> Self::IntoFuture {
        ...
        let fut = async move {
            ...
            let sdk_config = crate::attachment::AttachmentConfig {
                ...
                generate_blurhash: config.generate_blurhash,
            };
...
mod galleries {
    ...
    use crate::{boxed_into_future, ui::timeline::GalleryConfig};
    ...
    impl<'a> IntoFuture for SendGallery<'a> {
        ...
        fn into_future(self) -> Self::IntoFuture {
            ...
            let fut = async move {
                ...
                let mut config = crate::attachment::GalleryConfig::new();
