...
///
/// [`RoomInfo::recency_stamp`]: crate::base::RoomInfo::recency_stamp
/// [`RoomInfo::latest_event_value`]: crate::base::RoomInfo::latest_event_value
...
mod tests {
    ...
    use crate::{
        RoomRecencyStamp,
        base::RoomInfoNotableUpdateReasons,
