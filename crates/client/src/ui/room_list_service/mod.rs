...
impl RoomListService {
    ...
    ///
    /// A [`crate::SlidingSync`] client will be created, with a cached list
    /// already pre-configured.
    ///
    /// This won't start an encryption sync, and it's the user's responsibility
    /// to create one in this case using
    /// [`EncryptionSyncService`][crate::ui::encryption_sync_service::EncryptionSyncService].
    ...
    ///   profiles
    ///
    /// [`SlidingSyncBuilder::share_pos`]: crate::sliding_sync::SlidingSyncBuilder::share_pos
    ...
    /// using the [`SyncService`](crate::ui::sync_service::SyncService) instead.
    #[doc(hidden)]
    ...
    ///
    /// This is used by [`SyncService`](crate::ui::sync_service::SyncService).
    ///
    ...
    ///
    /// [listen_to_room]: crate::latest_events::LatestEvents::listen_to_room
    /// [`LatestEventValue`]: crate::latest_events::LatestEventValue
