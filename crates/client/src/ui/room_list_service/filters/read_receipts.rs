...
///
/// [`ReadReceipts`]: crate::base::read_receipts::ReadReceipts
#[cfg_attr(feature = "uniffi", derive(uniffi::Enum))]
#[cfg_attr(feature = "uniffi", uniffi(name = "RoomListFilterReadReceipts"))]
pub enum Category {
    /// Filter by mentions, i.e. [`ReadReceipts::num_mentions`].
    ///
    /// [`ReadReceipts::num_mentions`]: crate::base::read_receipts::ReadReceipts::num_mentions
    Mentions,

    /// Filter by notifications, i.e. [`ReadReceipts::num_notifications`].
    ///
    /// [`ReadReceipts::num_notifications`]: crate::base::read_receipts::ReadReceipts::num_notifications
    Notifications,

    /// Filter by messages, i.e. [`ReadReceipts::num_unread`].
    ///
    /// [`ReadReceipts::num_unread`]: crate::base::read_receipts::ReadReceipts::num_unread
    Messages,
}
...
mod tests {
    ...
    use crate::{test::async_test, test_utils::mocks::MatrixMockServer};
    ...
    async fn test_build_matches_select_the_correct_category() {
        ...
        room.inner()
            .update_room_info(|mut room_info| {
                room_info.set_read_receipts(crate::base::read_receipts::ReadReceipts {
                    num_unread: 1,
                    num_notifications: 2,
                    num_mentions: 3,
                    ..Default::default()
