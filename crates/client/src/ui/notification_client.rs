...
use crate::{
    ...
    base::{RoomState, StoreError, deserialized_responses::TimelineEvent},
                ...
                if let Some(permit_guard) = sync_service.try_get_encryption_sync_permit() {
                    ...
                    for _ in 0..3 {
                        ...
                        match new_event.kind {
                            crate::deserialized_responses::TimelineEventKind::UnableToDecrypt {
                                utd_info,
                                ..
                            } => {
...
mod tests {
    ...
    use crate::{
        ...
        ui::notification_client::{
            NotificationClient, NotificationItem, NotificationItemsRequest,
            NotificationProcessSetup, NotificationStatus, RawNotificationEvent,
        },
    };
