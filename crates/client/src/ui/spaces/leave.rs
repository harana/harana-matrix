...
use crate::{
    Client, ROOM_VERSION_RULES_FALLBACK, RoomState,
    room::RoomMemberRole,
    ui::spaces::{Error, SpaceRoom},
};
...
/// provided by the [`crate::ui::spaces::SpaceService`] and annotates them with
