...
use crate::{Room, RoomHero, RoomHeroWithProfile, RoomState};
...
impl SpaceRoom {
    ...
    pub(crate) async fn new_from_summary(
        ...
        let display_name = crate::base::Room::compute_display_name_with_fields(
            summary.name.clone(),
...
mod tests {
    ...
    use crate::{
        test::async_test,
        ui::spaces::{SpaceRoom, room::SpaceRoomChildState},
    };
