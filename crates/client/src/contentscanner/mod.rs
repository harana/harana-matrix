...
pub use crate::contentscanner::api::scan::MediaScanResponse;
#[cfg(feature = "e2e-encryption")]
use crate::crypto::AttachmentDecryptor;
use crate::{
    ...
    crypto::olm::Curve25519PublicKey,
...
impl MediaFetcher for ContentScannerMediaFetcher {
    ...
    ) -> BoxFuture<'a, crate::Result<Vec<u8>, Error>> {
        Box::pin(async move {
...
mod tests {
    ...
    #[cfg(feature = "e2e-encryption")]
    use crate::contentscanner::ContentScannerMediaFetcher;
    #[cfg(feature = "e2e-encryption")]
    use crate::media::{MediaFormat, MediaRequestParameters};
    use crate::{
        HttpError, RumaApiError,
        contentscanner::{ContentScanner, ContentScannerError, ErrorReason},
        test::async_test,
