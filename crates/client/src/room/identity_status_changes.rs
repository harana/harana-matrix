...
use crate::{
    Client, Error, Result,
    base::crypto::{IdentityState, IdentityStatusChange, RoomIdentityChange, RoomIdentityState},
...
fn to_base_updates(input: IdentityUpdates) -> crate::base::crypto::store::types::IdentityUpdates {
    crate::base::crypto::store::types::IdentityUpdates {
...
) -> BTreeMap<OwnedUserId, crate::base::crypto::UserIdentity> {
...
mod tests {
    ...
    use crate::{
        ...
        base::crypto::IdentityState,
        test::{async_test, test_json::keys_query_sets::IdentityChangeDataSet},
    };
