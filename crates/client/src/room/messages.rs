...
use crate::{
    Result,
    common::{debug::DebugStructExt as _, deserialized_responses::TimelineEvent},
};
...
/// [`harana_matrix_common::api::client::context::get_context::v3::Response`],
/// with events decrypted if needs be.
#[derive(Debug, Default)]
