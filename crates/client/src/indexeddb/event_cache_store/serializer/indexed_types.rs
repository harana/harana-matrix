...
//! [`crate::indexeddb::event_cache_store::types`] and prepare those types for
...
//! [`crate::indexeddb::event_cache_store::migrations`].
...
use crate::{
    base::linked_chunk::{ChunkIdentifier, LinkedChunkId},
    ...
    indexeddb::{
        ...
        serializer::{
            indexed_type::{
                constants::{
                    INDEXED_KEY_LOWER_CHARACTER, INDEXED_KEY_LOWER_STRING,
                    INDEXED_KEY_UPPER_CHARACTER, INDEXED_KEY_UPPER_STRING,
                },
                traits::{
...
/// (see [`RelationType`](harana_matrix_common::events::relation::RelationType))
...
///
/// [1]: crate::indexeddb::event_cache_store::migrations::v1::create_lease_object_store
...
///
/// [1]: crate::indexeddb::event_cache_store::migrations::v8::create_key_value_object_store
#[derive(Debug, Serialize, Deserialize)]
...
///
/// [1]: crate::indexeddb::event_cache_store::migrations::v1::create_linked_chunks_object_store
#[derive(Debug, Serialize, Deserialize)]
...
///
/// [1]: crate::indexeddb::event_cache_store::migrations::v1::create_events_object_store
#[derive(Debug, Serialize, Deserialize)]
...
/// - The (possibly) hashed Event ID.
///
/// [1]: crate::indexeddb::event_cache_store::migrations::v3::create_events_object_store
#[derive(Debug, Serialize, Deserialize)]
...
///
/// [1]: crate::indexeddb::event_cache_store::migrations::v1::create_gaps_object_store
#[derive(Debug, Serialize, Deserialize)]
...
///
/// [1]: crate::indexeddb::event_cache_store::migrations::v5::create_threads_object_store
#[derive(Debug, Serialize, Deserialize)]
