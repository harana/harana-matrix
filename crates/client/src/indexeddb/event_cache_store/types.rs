...
/// [`IndexeddbEventCacheStore`](crate::indexeddb::event_cache_store::IndexeddbEventCacheStore)
...
/// Representation of a [`Chunk`](crate::base::linked_chunk::Chunk)
...
pub struct Chunk {
    ...
    /// [`ChunkIdentifier`](crate::base::linked_chunk::ChunkIdentifier).
    pub identifier: u64,
...
/// [`Event`](crate::base::event_cache::Event) which can be stored in
/// IndexedDB.
///
...
impl Event {
    ...
    /// [`RelationType`](harana_matrix_common::events::relation::RelationType)
    /// of the underlying event as a [`String`].
...
/// A representation of [`Position`](crate::base::linked_chunk::Position)
/// which can be stored in IndexedDB.
...
impl From<Position> for crate::base::linked_chunk::Position {
    fn from(value: Position) -> Self {
        Self::new(ChunkIdentifier::new(value.chunk_identifier), value.index)
    }
}

impl From<crate::base::linked_chunk::Position> for Position {
    fn from(value: crate::base::linked_chunk::Position) -> Self {
        Self { chunk_identifier: value.chunk_identifier().index(), index: value.index() }
    }
}

/// A representation of [`Gap`](crate::base::linked_chunk::Gap)
/// which can be stored in IndexedDB.
#[derive(Debug, Serialize, Deserialize)]
pub struct Gap {
