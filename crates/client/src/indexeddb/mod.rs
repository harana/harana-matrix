...
use crate::base::store::StoreError;
...
impl IndexeddbStores {
    ...
    ///
    /// [1]: crate::store_encryption::StoreCipher
    pub async fn open(
        name: &str,
...
#[doc(hidden)]
pub use crate::indexeddb_event_cache_store_integration_tests;
