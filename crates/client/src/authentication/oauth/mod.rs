...
#[cfg(feature = "e2e-encryption")]
use crate::base::crypto::types::qr_login::QrCodeData;
use crate::base::{SessionMeta, store::RoomLoadSettings, ttl::TtlValue};
#[cfg(feature = "e2e-encryption")]
...
impl OAuth {
    ...
    /// # use crate::authentication::oauth::ClientId;
    /// # use crate::authentication::oauth::registration::ClientMetadata;
    ...
    async fn exchange_device_code(
        ...
        let response = OAuthClient::new(client_id)
            ...
            .request_async(self.http_client(), crate::common::sleep::sleep, None)
            .await?;
