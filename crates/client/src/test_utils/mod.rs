...
use crate::base::{deserialized_responses::TimelineEvent, store::RoomLoadSettings};
...
impl crate::HttpSend for NoTransport {
    ...
    ) -> crate::common::BoxFuture<'a, Result<http::Response<bytes::Bytes>, crate::HttpError>> {
...
/// use tokio::sync::mpsc;
///
/// use crate::assert_recv_with_timeout;
///
/// # async {
...
/// ```
/// # async {
/// # use crate::assert_next_eq_with_timeout;
...
/// # let room_id: harana_matrix_common::OwnedRoomId = unreachable!();
/// # let event_id: harana_matrix_common::OwnedEventId = unreachable!();
/// use crate::assert_let_decrypted_state_event_content;
///
/// let room =
///     client.get_room(&room_id).expect("Bob should have received the invite");
///
...
///         harana_matrix_common::events::room::topic::RoomTopicEventContent {
///             topic,
///             ..
///         }
///     ) = event
