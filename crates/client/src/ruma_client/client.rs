...
use crate::ruma_client::{
    Error, HttpClient, ResponseError, ResponseResult, send_customized_request,
};
...
impl<C: HttpClient> Client<C> {
    ...
    pub async fn register_guest(
        ...
        register::v3::Response,
        Error<C::Error, harana_matrix_common::api::client::uiaa::UiaaResponse>,
    > {
        let response = self
    ...
    /// #     .build::<crate::ruma_client::http_client::Dummy>()
    /// #     .await?;
    ...
    pub fn sync(
        ...
        Item = Result<
            ...
            Error<C::Error, harana_matrix_common::api::error::Error>,
        >,
    > + '_ {
        try_stream! {
            loop {
