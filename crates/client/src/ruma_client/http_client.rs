...
use crate::ruma_client::{ResponseError, ResponseResult};
...
/// `crate::ruma_client::Client`, this trait should make that relatively easy.
pub trait HttpClientExt: HttpClient {
    ...
    {
        Box::pin(crate::ruma_client::send_customized_request(
            self,
            homeserver_url,
            access_token,
            path_builder_input,
