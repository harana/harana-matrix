...
use crate::{
    base::{RoomInfoNotableUpdate, RoomInfoNotableUpdateReasons, timer},
    client::WeakClient,
    common::task_monitor::{BackgroundTaskHandle, TaskMonitor},
...
fn local_room_message(body: &str) -> LocalLatestEventValue {
    ...
    use crate::base::store::SerializableEventContent;
...
mod tests {
    ...
    use crate::{
        ...
        test::{InvitedRoomBuilder, JoinedRoomBuilder, async_test, event_factory::EventFactory},
