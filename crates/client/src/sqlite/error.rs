...
#[cfg(feature = "event-cache-store")]
use crate::base::event_cache::store::EventCacheStoreError;
#[cfg(feature = "media-store")]
use crate::base::media::store::MediaStoreError;
#[cfg(feature = "state-store")]
use crate::base::store::StoreError as StateStoreError;
#[cfg(feature = "crypto-store")]
use crate::crypto::CryptoStoreError;
use crate::sqlite::connection::{CreatePoolError, PoolError};
...
pub enum OpenStoreError {
    ...
    InitCipher(#[from] crate::store_encryption::Error),
...
pub enum Error {
    ...
    #[error(transparent)]
    Codec(#[from] crate::store_encryption::CodecError),

    #[error(transparent)]
    Encryption(crate::store_encryption::Error),
...
impl_from!(crate::store_encryption::Error => Error::Encryption);
