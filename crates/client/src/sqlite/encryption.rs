...
/// opened.
///
/// Derived from a [`SqliteStoreConfig`](crate::sqlite::SqliteStoreConfig) and
/// turned into a [`StoreEncryption`] once a connection is available, by
/// [`SqliteKeyValueStoreAsyncConnExt::open_store_encryption`].
///
/// [`SqliteKeyValueStoreAsyncConnExt::open_store_encryption`]: crate::sqlite::utils::SqliteKeyValueStoreAsyncConnExt::open_store_encryption
#[derive(Clone, Debug)]
...
mod tests {
    ...
    use super::*;
    use crate::{
        base::{StateStore, StateStoreDataKey, StateStoreDataValue},
        sqlite::{SqliteStateStore, SqliteStoreConfig},
        store_encryption::{
