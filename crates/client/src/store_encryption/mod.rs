...
#![doc = include_str!("../../docs/store_encryption.md")]
...
/// ```
/// # let example = || {
/// use crate::store_encryption::StoreCipher;
...
impl StoreCipher {
    ...
    /// ```rust,no_run
    /// # let example = || {
    /// use crate::store_encryption::{MessagePackCodec, StoreCipher};
    /// use serde_json::{json, value::Value};
    ///
    /// let store_cipher = StoreCipher::new()?;
    ///
