...
use harana_matrix_client::{
    ...
    base::crypto::types::events::room::encrypted::EncryptedToDeviceEvent,
...
struct Test {
    ...
    alice: Client,
    bob: Client,
    bob_room: harana_matrix_client::Room,
...
async fn setup_shared_history(
    bob_builder_fn: impl FnOnce(
        harana_matrix_client::ClientBuilder,
    ) -> harana_matrix_client::ClientBuilder,
) -> Test {
