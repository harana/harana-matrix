...
#[cfg(feature = "sqlite")]
use harana_matrix_client::test::InvitedRoomBuilder;
use harana_matrix_client::{
    ...
    base::{RoomState, sync::RoomUpdates},
    common::{cross_process_lock::CrossProcessLockConfig, executor::spawn},
    ...
    test::{
        ...
        test_json::{
            self,
            sync::{
                MIXED_INVITED_ROOM_ID, MIXED_JOINED_ROOM_ID, MIXED_KNOCKED_ROOM_ID,
                MIXED_LEFT_ROOM_ID, MIXED_SYNC,
            },
        },
    },
    test_utils::{
...
async fn test_sync_thread_subscriptions_with_catchup() {
    ...
    assert_eq!(sub1, Some(harana_matrix_client::room::ThreadSubscription { automatic: true }));
    ...
    assert_eq!(sub3, Some(harana_matrix_client::room::ThreadSubscription { automatic: false }));
}
