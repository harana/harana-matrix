...
use harana_matrix_client::{
    ...
    base::sync::UnreadNotificationsCount,
    ...
    ui::{
        ...
        room_list_service::{
            ...
            SyncIndicator,
            filters::{
                new_filter_deduplicate_versions, new_filter_fuzzy_match_room_name,
                new_filter_non_left, new_filter_none,
            },
        },
...
async fn test_thread_subscriptions_extension_enabled_only_if_server_advertises_it() {
...

    {
        ...
        let client = server
            ...
            .no_server_versions()
            .on_builder(|b| {
                b.with_threading_support(harana_matrix_client::ThreadingSupport::Enabled {
