...
use harana_matrix_client::attachment::{AttachmentInfo, BaseFileInfo};
#[cfg(feature = "unstable-msc4274")]
use harana_matrix_client::ui::timeline::{GalleryConfig, GalleryItemInfo};
use harana_matrix_client::{
    assert_let_timeout,
    attachment::Thumbnail,
    media::{MediaFormat, MediaRequestParameters, MediaThumbnailSettings},
    send_queue::AbstractProgress,
    test::{ALICE, JoinedRoomBuilder, TestResult, async_test, event_factory::EventFactory},
...
async fn test_download_media_of_an_event_without_media() -> TestResult {
    ...
    assert_matches!(
        ...
        Err(harana_matrix_client::ui::timeline::Error::EventHasNoMedia)
    );
