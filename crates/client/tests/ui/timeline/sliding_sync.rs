...
use harana_matrix_client::{
    ...
    ui::timeline::{TimelineBuilder, TimelineItem, TimelineItemKind, TimelineReadReceiptTracking},
};
                ...
                $( $accumulator )*
                {
                    assert_matches!(
                        ...
                        Some(eyeball_im::VectorDiff::PushBack { value }) => {
                            assert_matches!(
                                **value,
                                harana_matrix_client::ui::timeline::TimelineItemKind::Virtual(
                                    harana_matrix_client::ui::timeline::VirtualTimelineItem::DateDivider(_)
                                ),
                ...
                $( $accumulator )*
                {
                    assert_matches!(
                        ...
                        Some(eyeball_im::VectorDiff::PushBack { value }) => {
                            assert_matches!(
                                &**value,
                                harana_matrix_client::ui::timeline::TimelineItemKind::Event(event_timeline_item) => {
                                    assert_eq!(
                    ...
                    assert_matches!(
                        ...
                        Some(eyeball_im::VectorDiff::PushFront { value }) => {
                            assert_matches!(
                                &**value,
                                harana_matrix_client::ui::timeline::TimelineItemKind::Virtual(
                                    harana_matrix_client::ui::timeline::VirtualTimelineItem::TimelineStart
                                ),
...
async fn create_one_room(
    ...
    stream: &mut Pin<&mut impl Stream<Item = harana_matrix_client::Result<UpdateSummary>>>,
    room_id: &RoomId,
    room_name: String,
) -> Result<()> {
...
async fn test_timeline_refreshes_sender_profile_on_global_profile_update() -> Result<()> {
    use harana_matrix_client::ui::timeline::TimelineDetails;
