...
//!
//! This module used with [`crate::__ruma::signatures`] should allow to perform all the [necessary checks on
//! receipt of a PDU].
//!
...
//! 2. [`crate::__ruma::signatures::verify_event()`] - The event should be dropped on error. The PDU should be
...
//! # Event helper types
//!
//! The types from [`crate::__ruma::events`] use strict deserialization rules according to their definition in
...
//!
//! The types from [`crate::__ruma::events`] are still appropriate to be used to create a new event, or to
