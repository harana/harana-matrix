...
/// Representation of a [`Chunk`](base::linked_chunk::Chunk)
...
pub struct Chunk {
    ...
    /// [`ChunkIdentifier`](base::linked_chunk::ChunkIdentifier).
    pub identifier: u64,
...
/// [`Event`](base::event_cache::Event) which can be stored in
/// IndexedDB.
///
...
/// A representation of [`Position`](base::linked_chunk::Position)
/// which can be stored in IndexedDB.
...
impl From<Position> for base::linked_chunk::Position {
    fn from(value: Position) -> Self {
        Self::new(ChunkIdentifier::new(value.chunk_identifier), value.index)
    }
}

impl From<base::linked_chunk::Position> for Position {
    fn from(value: base::linked_chunk::Position) -> Self {
        Self { chunk_identifier: value.chunk_identifier().index(), index: value.index() }
    }
}

/// A representation of [`Gap`](base::linked_chunk::Gap)
/// which can be stored in IndexedDB.
#[derive(Debug, Serialize, Deserialize)]
pub struct Gap {
