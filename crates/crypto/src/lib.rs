...
#[cfg(test)]
sdk_test_utils::init_tracing_for_tests!();
...
/// # use anyhow::Result;
/// # use crypto::{OlmMachine, types::requests::OutgoingRequest};
...
/// # use std::collections::BTreeMap;
/// # use anyhow::Result;
/// # use crypto::{OlmMachine, DecryptionSettings, TrustRequirement};
/// # #[tokio::main]
/// # async fn main() -> Result<()> {
...
/// # use ruma::UserId;
/// # use ruma::api::client::keys::claim_keys::v3::{Response, Request};
/// # use crypto::{OlmMachine, types::requests::ToDeviceRequest, EncryptionSettings};
...
/// ```no_run
/// # use anyhow::Result;
/// # use crypto::{DecryptionSettings, OlmMachine, TrustRequirement};
...
/// # use ruma::api::client::keys::claim_keys::v3::{Response, Request};
/// # use crypto::{EncryptionSettings, OlmMachine, types::requests::ToDeviceRequest};
