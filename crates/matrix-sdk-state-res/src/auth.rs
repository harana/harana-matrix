    ...
    EventFut: Future<Output = Option<E>> + Send,
{
    ...
    for round in 0..MAX_FETCH_ROUNDS {
        ...
        let result = ruma::state_res::check_state_independent_auth_rules(
            &rules.authorization,
            incoming_event,
    ...
    StateFut: Future<Output = Option<E>> + Send,
{
    ...
    for round in 0..MAX_FETCH_ROUNDS {
        ...
        let result = ruma::state_res::check_state_dependent_auth_rules(
            &rules.authorization,
            incoming_event,
...
fn room_create_event_id(room_id: &RoomId) -> Result<OwnedEventId, ruma::IdParseError> {
