...
pub struct EventContentAttrs {
    ...
    /// Whether the `Redacted*EventContent` type is implemented manually rather
    /// than generated by this macro.
    has_custom_redacted: bool,

    /// Whether the `PossiblyRedacted*EventContent` type is implemented manually
...
impl EventContentAttrs {
    ...
    /// Set that the `Redacted*EventContent` type is implemented manually rather
    /// than generated by this macro.
    ///
    /// Returns an error if it is already set.
    ...
    /// Set that the `PossiblyRedacted*EventContent` type is implemented
    ...
    /// Set that this macro should generate an `*EventContentWithoutRelation`
    /// type.
    ///
    /// Returns an error if it is already set.
...
///
/// This is a wrapper around [`EventKind`] that allows to provide two kinds for
