...
///
/// ```
/// use common_ruma::{DeviceKeyAlgorithm, DeviceKeyId};
///
...
#[derive(IdDst)]
#[ruma_id(
    validate = common_identifiers_validation::key_id::validate::<K>,
)]
...
impl<A: KeyAlgorithm, K: KeyName + ?Sized> KeyId<A, K> {
    ...
    ///
    /// ```
    /// use common_ruma::{DeviceKeyId, device_id};
    ///
...
mod tests {
    ...
    use common_identifiers_validation::Error;
