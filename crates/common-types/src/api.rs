...
/// ```
/// pub mod do_a_thing {
///     use common_ruma::{OwnedRoomId, api::request};
///     # use common_ruma::{api::{auth_scheme::NoAuthentication, response}, metadata};
///
///     // metadata! { ... };
///     # metadata! {
///     #     method: POST,
...
/// ```
/// pub mod do_a_thing {
///     use common_ruma::{OwnedRoomId, api::response};
///     # use common_ruma::{api::{auth_scheme::NoAuthentication, request}, metadata};
///
///     // metadata! { ... };
///     # metadata! {
///     #     method: POST,
