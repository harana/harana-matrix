                ...
                $( $accumulator )*
                {
                    assert_matches!(
                        ...
                        Some(eyeball_im::VectorDiff::PushBack { value }) => {
                            assert_matches!(
                                **value,
                                client_ui::timeline::TimelineItemKind::Virtual(
                                    client_ui::timeline::VirtualTimelineItem::DateDivider(_)
                                ),
                ...
                $( $accumulator )*
                {
                    assert_matches!(
                        ...
                        Some(eyeball_im::VectorDiff::PushBack { value }) => {
                            assert_matches!(
                                &**value,
                                client_ui::timeline::TimelineItemKind::Event(event_timeline_item) => {
                                    assert_eq!(
                    ...
                    assert_matches!(
                        ...
                        Some(eyeball_im::VectorDiff::PushFront { value }) => {
                            assert_matches!(
                                &**value,
                                client_ui::timeline::TimelineItemKind::Virtual(
                                    client_ui::timeline::VirtualTimelineItem::TimelineStart
                                ),
...
async fn create_one_room(
    ...
    stream: &mut Pin<&mut impl Stream<Item = client_matrix::Result<UpdateSummary>>>,
    room_id: &RoomId,
    room_name: String,
) -> Result<()> {
