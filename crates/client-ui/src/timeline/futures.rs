...
use client_matrix::TransmissionProgress;
use client_base::boxed_into_future;
use mime::Mime;
...
impl<'a> IntoFuture for SendAttachment<'a> {
    ...
    fn into_future(self) -> Self::IntoFuture {
        ...
        let fut = async move {
            ...
            let sdk_config = client_matrix::attachment::AttachmentConfig {
    ...
    impl<'a> IntoFuture for SendGallery<'a> {
        ...
        fn into_future(self) -> Self::IntoFuture {
            ...
            let fut = async move {
                ...
                let mut config = client_matrix::attachment::GalleryConfig::new();
