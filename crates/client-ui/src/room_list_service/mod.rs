...
impl RoomListService {
    ...
    ///
    /// A [`client_matrix::SlidingSync`] client will be created, with a cached list
    ...
    ///   profiles
    ///
    /// [`SlidingSyncBuilder::share_pos`]: client_matrix::sliding_sync::SlidingSyncBuilder::share_pos
    ...
    ///
    /// [listen_to_room]: client_matrix::latest_events::LatestEvents::listen_to_room
    /// [`LatestEventValue`]: client_matrix::latest_events::LatestEventValue
...
#[derive(Debug, Error)]
pub enum Error {
    /// Error from [`client_matrix::SlidingSync`].
    #[error(transparent)]
