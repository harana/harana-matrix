...
pub mod v3 {
    ...
    use crate::__ruma::events::{AnyGlobalAccountDataEventContent, GlobalAccountDataEventType};
    ...
    pub struct Response {
        ...
        ///
        /// [`SecretStorageKeyEventContent`]: crate::__ruma::events::secret_storage::key::SecretStorageKeyEventContent
        #[ruma_api(body)]
