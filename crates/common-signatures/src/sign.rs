...
use crate::{JsonError, add_content_hash_to_event, to_canonical_json_string_for_signing};
...
///
/// ```rust
/// # use common_ruma::{RoomVersionId, serde::base64::Base64};
/// # use common_ruma::signatures::{hash_and_sign_event, Ed25519KeyPair};
/// #
/// const PKCS8: &str = "\
...
///
/// ```rust
/// use common_ruma::CanonicalJsonObject;
/// use common_ruma::signatures::sign_event;
...
/// # let key_pair = common_ruma::signatures::Ed25519KeyPair::from_der(
/// #    der.as_bytes(),
/// #    "1".into(), // The "version" of the key.
/// # )?;
/// # let room_version_rules = || { common_ruma::room_version_rules::RoomVersionRules::V6 };
///
/// // Deserialize an event from JSON.
...
///
/// ```rust
/// # use common_ruma::serde::base64::Base64;
/// #
/// const PKCS8: &str = "\
///     MFECAQEwBQYDK2VwBCIEINjozvdfbsGEt6DD+7Uf4PiJ/YvTNXV2mIPc/\
///     tA0T+6tgSEA3TPraTczVkDPTRaX4K+AfUuyx7Mzq1UafTXypnl0t2k\
...
/// assert!(common_ruma::signatures::sign_json("domain", &key_pair, &mut value).is_ok());
/// ```
///
