...
use client_base::media::store::IgnoreMediaRetentionPolicy;
pub use client_base::media::{store::MediaRetentionPolicy, *};
#[cfg(not(target_family = "wasm"))]
...
impl Media {
    ...
    /// ```no_run
    /// # use std::fs;
    /// # use client_matrix::{Client, ruma::room_id};
    /// # use url::Url;
    /// # use mime;
    /// # async {
    ...
    /// # };
    /// # use client_matrix::ruma::{events::room::MediaSource, owned_mxc_uri};
    /// # async {
            ...
            match &request.source {
                MediaSource::Encrypted(file) => {
                    ...
                    let content = {
                        ...
                        let mut reader = client_base::crypto::AttachmentDecryptor::new(
                            &mut cursor,
