...
) -> client_base::crypto::store::types::IdentityUpdates {
    client_base::crypto::store::types::IdentityUpdates {
...
) -> BTreeMap<OwnedUserId, client_base::crypto::UserIdentity> {
...
mod tests {
    ...
    use client_base::crypto::IdentityState;
    use common_test::{async_test, test_json::keys_query_sets::IdentityChangeDataSet};
