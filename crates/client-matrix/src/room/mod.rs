...
use client_base::crypto::types::events::room::encrypted::EncryptedEvent;
#[cfg(feature = "e2e-encryption")]
...
pub use client_base::store::StoredThreadSubscription;
use client_base::{
...
#[cfg(feature = "e2e-encryption")]
use client_base::{crypto::RoomEventDecryptionResult, deserialized_responses::EncryptionInfo};
#[cfg(feature = "e2e-encryption")]
...
impl Room {
    ...
    /// # use client_matrix::ruma::room_id;
    /// # use client_matrix::media::MediaFormat;
    /// # use url::Url;
    ...
    ///
    /// ```no_run
    /// use client_matrix::{Client, room::MessagesOptions};
    ...
    /// # async {
    /// # let room: client_matrix::Room = todo!();
    /// # let user_ids: &[client_matrix::ruma::OwnedUserId] = &[];
    /// use client_matrix::ruma::events::room::member::RoomMemberEventContent;
    ///
    ...
    /// # async {
    /// # let room: client_matrix::Room = todo!();
    /// use client_matrix::ruma::events::room::power_levels::RoomPowerLevelsEventContent;
    ///
    ...
    /// # let room_id = client_matrix::ruma::room_id!("!test:localhost");
    /// use client_matrix::ruma::events::tag::TagInfo;
    ///
    ...
    ///
    /// use client_matrix::ruma::api::client::typing::create_typing_event::v3::Typing;
    /// # use client_matrix::{
    ...
    /// ```no_run
    /// # use std::fs;
    /// # use client_matrix::{Client, ruma::room_id, attachment::AttachmentConfig};
    /// # use url::Url;
    /// # use mime;
    /// # async {
    /// # let homeserver = Url::parse("http://localhost:8080")?;
    ...
    /// # use serde::{Deserialize, Serialize};
    /// # async {
    /// # let joined_room: client_matrix::Room = todo!();
    /// use client_matrix::ruma::{
    ...
    ///
    /// ```no_run
    /// use client_matrix::ruma::event_id;
    ///
    /// # async {
    /// # let homeserver = url::Url::parse("http://localhost:8080")?;
    /// # let mut client = client_matrix::Client::new(homeserver).await?;
    ...
    /// result, use
    /// [`client_base::Room::cached_user_defined_notification_mode`].
    //
...
mod tests {
    ...
    use client_base::{ComposerDraft, DraftAttachment, store::ComposerDraftType};
    use common_test::{
    ...
    async fn test_cache_invalidation_while_encrypt() {
        ...
        use common_test::{DEFAULT_TEST_ROOM_ID, message_like_event_content};
    ...
    async fn test_composer_draft() {
        use common_test::DEFAULT_TEST_ROOM_ID;
        ...
        let draft = ComposerDraft {
            ...
            attachments: vec![DraftAttachment {
                ...
                content: client_base::DraftAttachmentContent::File {
                    data: b"meow".to_vec(),
