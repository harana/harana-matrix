...
impl crate::HttpSend for NoTransport {
    ...
    ) -> client_common::BoxFuture<'a, Result<http::Response<bytes::Bytes>, crate::HttpError>>
    {
...
/// use client_matrix::assert_next_with_timeout;
///
/// # async {
...
///
/// ```rust
/// use client_matrix::assert_recv_with_timeout;
/// use tokio::sync::mpsc;
///
/// # async {
...
/// ```
/// # async {
/// # use client_matrix::assert_next_eq_with_timeout;
