...
#[cfg(feature = "e2e-encryption")]
use client_base::crypto::types::qr_login::QrCodeData;
use client_base::{SessionMeta, store::RoomLoadSettings, ttl::TtlValue};
#[cfg(feature = "e2e-encryption")]
...
impl OAuth {
    ...
    async fn exchange_device_code(
        ...
        let response = OAuthClient::new(client_id)
            ...
            .request_async(self.http_client(), client_common::sleep::sleep, None)
            .await?;
