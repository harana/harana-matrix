...
use client_base::{RoomState, sync::RoomUpdates};
use client_common::{cross_process_lock::CrossProcessLockConfig, executor::spawn};
#[cfg(feature = "sqlite")]
use common_test::InvitedRoomBuilder;
use common_test::{
...
async fn test_sync_thread_subscriptions_with_catchup() {
    ...
    assert_eq!(sub1, Some(client_matrix::room::ThreadSubscription { automatic: true }));
    ...
    assert_eq!(sub3, Some(client_matrix::room::ThreadSubscription { automatic: false }));
}
