...
use client_matrix::attachment::{GalleryConfig, GalleryItemInfo};
use client_matrix::{
...
use client_base::store::QueuedRequestKind;
...
async fn test_media_uploads() {
    ...
    let config = AttachmentConfig::new()
        ...
        .reply(Some(Reply {
            ...
            enforce_thread: client_matrix::room::reply::EnforceThread::Threaded(ReplyWithinThread::No),
