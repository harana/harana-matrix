...
use crate::__ruma::serde::{Raw, from_raw_json_value};
...
mod tests {
    ...
    use crate::__ruma::{serde::Raw, user_id};
    use crate::__ruma::events::{AnyStrippedStateEvent, room::member::MembershipState};
