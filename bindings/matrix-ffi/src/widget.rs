...
pub fn make_widget_driver(settings: WidgetSettings) -> Result<WidgetDriverAndHandle, ParseError> {
    let (driver, handle) = matrix::widget::WidgetDriver::new(settings.try_into()?);
...
pub struct WidgetDriver(Mutex<Option<matrix::widget::WidgetDriver>>);
...
impl TryFrom<WidgetSettings> for matrix::widget::WidgetSettings {
    ...
    fn try_from(value: WidgetSettings) -> Result<Self, Self::Error> {
        ...
        Ok(matrix::widget::WidgetSettings::new(widget_id, init_after_content_load, &raw_url)?)
    }
}

impl From<matrix::widget::WidgetSettings> for WidgetSettings {
    fn from(value: matrix::widget::WidgetSettings) -> Self {
        WidgetSettings {
...
pub async fn generate_webview_url(
    ...
    Ok(matrix::widget::WidgetSettings::generate_webview_url(
...
pub fn new_virtual_element_call_widget(
    props: matrix::widget::VirtualElementCallWidgetProperties,
    config: matrix::widget::VirtualElementCallWidgetConfig,
) -> Result<WidgetSettings, ParseError> {
    Ok(matrix::widget::WidgetSettings::new_virtual_element_call_widget(props, config)
        .map(|w| w.into())?)
}
...
/// [`matrix::widget::Capabilities::element_call_required`], so it can be
...
pub fn get_element_call_required_permissions(
    ...
    Ok(matrix::widget::Capabilities::element_call_required(
        &own_user_id,
...
impl From<ClientProperties> for matrix::widget::ClientProperties {
...
#[derive(uniffi::Object)]
pub struct WidgetDriverHandle(matrix::widget::WidgetDriverHandle);
...
impl From<WidgetCapabilities> for matrix::widget::Capabilities {
...
impl From<matrix::widget::Capabilities> for WidgetCapabilities {
    fn from(value: matrix::widget::Capabilities) -> Self {
        Self {
            read: value.read.into_iter().map(Into::into).collect(),
            send: value.send.into_iter().map(Into::into).collect(),
            requires_client: value.requires_client,
...
impl From<WidgetEventFilter> for matrix::widget::Filter {
...
impl From<matrix::widget::Filter> for WidgetEventFilter {
    fn from(value: matrix::widget::Filter) -> Self {
        use matrix::widget::Filter as F;
...
impl matrix::widget::CapabilitiesProvider for CapabilitiesProviderWrap {
    async fn acquire_capabilities(
        &self,
        capabilities: matrix::widget::Capabilities,
...
#[cfg(test)]
mod tests {
    use matrix::widget::Capabilities;
