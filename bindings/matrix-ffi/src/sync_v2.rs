...
impl From<SyncSettingsV2> for matrix::config::SyncSettings {
    fn from(value: SyncSettingsV2) -> Self {
        let mut settings = matrix::config::SyncSettings::new();
...
impl From<matrix::sync::SyncResponse> for SyncResponseV2 {
    fn from(value: matrix::sync::SyncResponse) -> Self {
        Self {
