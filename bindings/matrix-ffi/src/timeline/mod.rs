...
use matrix::utils::formatted_body_from;
...
#[repr(transparent)]
pub struct Timeline {
    pub(crate) inner: ui::timeline::Timeline,
}

impl Timeline {
    pub(crate) fn new(inner: ui::timeline::Timeline) -> Arc<Self> {
        Arc::new(Self { inner })
    }
...
impl From<matrix::send_queue::AbstractProgress> for AbstractProgress {
    fn from(value: matrix::send_queue::AbstractProgress) -> Self {
        Self {
...
pub struct SendHandle {
    inner: Mutex<Option<matrix::send_queue::SendHandle>>,
}

impl SendHandle {
    fn new(handle: matrix::send_queue::SendHandle) -> Self {
...
impl TimelineDiff {
    pub(crate) fn new(inner: VectorDiff<Arc<ui::timeline::TimelineItem>>) -> Self {
        match inner {
...
pub struct TimelineItem(pub(crate) ui::timeline::TimelineItem);

impl TimelineItem {
    pub(crate) fn from_arc(arc: Arc<ui::timeline::TimelineItem>) -> Arc<Self> {
...
impl TimelineItem {
    ...
    pub fn as_virtual(self: Arc<Self>) -> Option<VirtualTimelineItem> {
        use ui::timeline::VirtualTimelineItem as VItem;
...
impl From<&ui::timeline::EventSendState> for EventSendState {
    fn from(value: &ui::timeline::EventSendState) -> Self {
        use ui::timeline::EventSendState::*;
        ...
        match value {
            ...
            SendingFailed { error, is_recoverable } => {
                let as_queue_wedge_error: matrix::QueueWedgeError = (&**error).into();
                Self::SendingFailed {
...
impl From<ui::timeline::EventTimelineItem> for EventTimelineItem {
    fn from(item: ui::timeline::EventTimelineItem) -> Self {
...
#[derive(Clone, uniffi::Object)]
pub struct LazyTimelineItemProvider(Arc<ui::timeline::EventTimelineItem>);
...
mod galleries {
    ...
    impl TryInto<ui::timeline::GalleryItemInfo> for GalleryItemInfo {
        ...
        fn try_into(
            ...
            Ok(ui::timeline::GalleryItemInfo {
