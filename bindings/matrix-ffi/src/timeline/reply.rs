...
use ui::timeline::{EmbeddedEvent, TimelineDetails};
...
impl From<ui::timeline::InReplyToDetails> for InReplyToDetails {
    fn from(inner: ui::timeline::InReplyToDetails) -> Self {
