...
impl TryFrom<ui::timeline::MsgLikeContent> for MsgLikeContent {
    type Error = (ClientError, String);

    fn try_from(value: ui::timeline::MsgLikeContent) -> Result<Self, Self::Error> {
        use ui::timeline::MsgLikeKind as Kind;
...
impl EncryptedMessage {
    pub(crate) fn new(msg: &ui::timeline::EncryptedMessage) -> Self {
        use ui::timeline::EncryptedMessage as Message;
...
impl From<ui::timeline::ThreadSummary> for ThreadSummary {
    fn from(value: ui::timeline::ThreadSummary) -> Self {
        Self {
