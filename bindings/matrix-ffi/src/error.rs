...
pub enum ClientError {
    ...
    ContentScanner { reason: contentscanner::ErrorReason, info: String },
}
...
impl From<matrix::Error> for ClientError {
    fn from(e: matrix::Error) -> Self {
        match e {
            matrix::Error::Http(http_error) => {
...
impl From<matrix::BeaconError> for LiveLocationError {
    fn from(value: matrix::BeaconError) -> Self {
        match value {
            matrix::BeaconError::Network(_) => Self::Network,
            matrix::BeaconError::NotFound => Self::NotFound,
            matrix::BeaconError::Redacted => Self::Redacted,
            matrix::BeaconError::Stripped => Self::Stripped,
            matrix::BeaconError::Deserialization(_) => Self::Deserialization,
            matrix::BeaconError::NotLive => Self::NotLive,
            matrix::BeaconError::Other(err) => Self::Other { msg: err.to_string() },
        }
    }
}
...
impl From<matrix::Error> for NotificationSettingsError {
    fn from(e: matrix::Error) -> Self {
