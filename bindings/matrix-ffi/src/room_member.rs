use matrix::room::{RoomMember as SdkRoomMember, RoomMemberRole};
...
impl TryFrom<matrix::ruma::events::room::member::MembershipState> for MembershipState {
    ...
    fn try_from(
        ...
        match m {
            ...
            matrix::ruma::events::room::member::MembershipState::Leave => {
                Ok(MembershipState::Leave)
            }
            matrix::ruma::events::room::member::MembershipState::_Custom(_) => {
...
impl TryFrom<matrix::room::RoomMemberWithSenderInfo> for RoomMemberWithSenderInfo {
    type Error = ClientError;

    fn try_from(value: matrix::room::RoomMemberWithSenderInfo) -> Result<Self, Self::Error> {
        Ok(Self {
