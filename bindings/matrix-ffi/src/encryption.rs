...
pub struct Encryption {
    pub(crate) inner: matrix::encryption::Encryption,
...
impl From<matrix::encryption::recovery::RecoveryError> for RecoveryError {
    fn from(value: matrix::encryption::recovery::RecoveryError) -> Self {
        match value {
            ...
            recovery::RecoveryError::SecretStorage(
                matrix::encryption::secret_storage::SecretStorageError::ImportError { .. },
...
impl From<matrix::encryption::backups::futures::SteadyStateError> for SteadyStateError {
    fn from(value: matrix::encryption::backups::futures::SteadyStateError) -> Self {
        match value {
...
pub struct SecretsBundleWithUserId {
    user_id: OwnedUserId,
    inner: base::crypto::types::SecretsBundle,
}
...
#[cfg(feature = "sqlite")]
impl From<matrix::encryption::BundleExportError> for BundleExportError {
    fn from(value: matrix::encryption::BundleExportError) -> Self {
        match value {
            matrix::encryption::BundleExportError::OpenStoreError(e) => {
                BundleExportError::OpenStoreError { msg: e.to_string() }
            }
            matrix::encryption::BundleExportError::StoreError(e) => {
                BundleExportError::StoreError { msg: e.to_string() }
            }
            matrix::encryption::BundleExportError::SecretExport(e) => {
...
impl SecretsBundleWithUserId {
    ...
    pub async fn from_database(
        ...
        let ret = if let Some((user_id, bundle)) =
            matrix::encryption::export_secrets_bundle_from_store(
                database_path,
                passphrase.as_deref(),
            )
            .await?
...
impl SecretsBundleWithUserId {
    ...
    pub fn from_str(
        ...
        let bundle: base::crypto::types::SecretsBundle = serde_json::from_str(bundle)?;
        let backup_info = serde_json::from_str(backup_info)?;
...
fn check_bundle_and_info(
    bundle: &base::crypto::types::SecretsBundle,
...
pub struct UserIdentity {
    inner: matrix::encryption::identities::UserIdentity,
}
...
pub struct IdentityResetHandle {
    pub(crate) inner: matrix::encryption::recovery::IdentityResetHandle,
}
...
impl From<&matrix::encryption::CrossSigningResetAuthType> for CrossSigningResetAuthType {
    fn from(value: &matrix::encryption::CrossSigningResetAuthType) -> Self {
        match value {
...
impl From<&matrix::encryption::OAuthCrossSigningResetInfo> for OAuthCrossSigningResetInfo {
    fn from(value: &matrix::encryption::OAuthCrossSigningResetInfo) -> Self {
