...
impl From<ui::room_list_service::Error> for RoomListError {
    fn from(value: ui::room_list_service::Error) -> Self {
        use ui::room_list_service::Error::*;
...
pub struct RoomListService {
    pub(crate) inner: Arc<ui::RoomListService>,
...
pub struct RoomList {
    ...
    inner: Arc<ui::room_list_service::RoomList>,
}
...
impl RoomList {
    ...
    fn entries_with_dynamic_adapters(
        ...
        // `ui::room_list_service::RoomList::entries_with_dynamic_adapters`
...
impl From<ui::room_list_service::State> for RoomListServiceState {
    fn from(value: ui::room_list_service::State) -> Self {
        use ui::room_list_service::State as S;
...
impl From<ui::room_list_service::SyncIndicator> for RoomListServiceSyncIndicator {
    fn from(value: ui::room_list_service::SyncIndicator) -> Self {
        use ui::room_list_service::SyncIndicator as SI;
...
impl From<ui::room_list_service::RoomListLoadingState> for RoomListLoadingState {
    fn from(value: ui::room_list_service::RoomListLoadingState) -> Self {
        use ui::room_list_service::RoomListLoadingState as LS;
...
pub struct RoomListDynamicEntriesController {
    inner: ui::room_list_service::RoomListDynamicEntriesController,
}

impl RoomListDynamicEntriesController {
    fn new(
        dynamic_entries_controller: ui::room_list_service::RoomListDynamicEntriesController,
    ) -> Self {
...
#[cfg(test)]
mod tests {
    use matrix::{ruma::room_id, test_utils::mocks::MatrixMockServer};
    use ui::room_list_service::{RoomListItem, filters::BoxedFilterFn};
