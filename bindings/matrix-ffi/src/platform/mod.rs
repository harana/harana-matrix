...
enum LogTarget {
    ...
    BaseEventCache,
    BaseSlidingSync,
    BaseStoreAmbiguityMap,
    BaseResponseProcessors,

    // SDK common modules.
    SdkCommonCrossProcessLock,
    SdkCommonDeserializedResponses,

    // SDK modules.
    Matrix,
    MatrixClient,
    Crypto,
    CryptoIdentitiesManager,
    CryptoAccount,
    MatrixEventCache,
    MatrixEventCacheStore,
    MatrixHttpClient,
    MatrixLatestEvents,
    MatrixOauth,
    MatrixSendQueue,
...
impl LogTarget {
    fn as_str(&self) -> &'static str {
        match self {
            ...
            LogTarget::MatrixFfi => "matrix_ffi",
            LogTarget::BaseEventCache => "base::event_cache",
            LogTarget::BaseSlidingSync => "base::sliding_sync",
            ...
            LogTarget::CryptoIdentitiesManager => "crypto::identities::manager",
            LogTarget::CryptoAccount => "crypto::olm::account",
            LogTarget::MatrixOauth => "matrix::authentication::oauth",
            LogTarget::MatrixHttpClient => "matrix::http_client",
            LogTarget::MatrixSlidingSync => "matrix::sliding_sync",
            LogTarget::MatrixEventCache => "matrix::event_cache",
            LogTarget::MatrixLatestEvents => "matrix::latest_events",
            LogTarget::MatrixSendQueue => "matrix::send_queue",
            LogTarget::MatrixEventCacheStore => EVENT_CACHE_STORE_LOG_TARGET,
            LogTarget::UiTimeline => "ui::timeline",
            LogTarget::UiNotificationClient => "ui::notification_client",
            LogTarget::Search => "search",
        }
    }
}
...
#[cfg(feature = "sqlite")]
const EVENT_CACHE_STORE_LOG_TARGET: &str = matrix::sqlite_log_targets::EVENT_CACHE_STORE;

#[cfg(not(feature = "sqlite"))]
const EVENT_CACHE_STORE_LOG_TARGET: &str = "base::event_cache::store";

const DEFAULT_TARGET_LOG_LEVELS: &[(LogTarget, LogLevel)] = &[
    (LogTarget::Hyper, LogLevel::Warn),
    (LogTarget::MatrixFfi, LogLevel::Info),
    (LogTarget::Matrix, LogLevel::Info),
    (LogTarget::MatrixClient, LogLevel::Trace),
    (LogTarget::Crypto, LogLevel::Debug),
    (LogTarget::CryptoIdentitiesManager, LogLevel::Info),
    (LogTarget::CryptoAccount, LogLevel::Trace),
    (LogTarget::MatrixOauth, LogLevel::Trace),
    (LogTarget::MatrixHttpClient, LogLevel::Debug),
    (LogTarget::MatrixSlidingSync, LogLevel::Info),
    (LogTarget::BaseSlidingSync, LogLevel::Info),
    (LogTarget::UiTimeline, LogLevel::Info),
    (LogTarget::MatrixSendQueue, LogLevel::Info),
    (LogTarget::MatrixEventCache, LogLevel::Info),
    (LogTarget::MatrixLatestEvents, LogLevel::Info),
    (LogTarget::BaseEventCache, LogLevel::Info),
    (LogTarget::MatrixEventCacheStore, LogLevel::Info),
    (LogTarget::SdkCommonCrossProcessLock, LogLevel::Warn),
    (LogTarget::SdkCommonDeserializedResponses, LogLevel::Warn),
    (LogTarget::BaseStoreAmbiguityMap, LogLevel::Warn),
    (LogTarget::UiNotificationClient, LogLevel::Info),
    (LogTarget::BaseResponseProcessors, LogLevel::Info),
    (LogTarget::Search, LogLevel::Info),
];
    ...
    fn targets(&self) -> &[LogTarget] {
        match self {
            TraceLogPacks::EventCache => &[
                LogTarget::MatrixEventCache,
                LogTarget::BaseEventCache,
                LogTarget::MatrixEventCacheStore,
                LogTarget::SdkCommonCrossProcessLock,
                LogTarget::SdkCommonDeserializedResponses,
            ],
            TraceLogPacks::SendQueue => &[LogTarget::MatrixSendQueue],
            TraceLogPacks::Timeline => {
                &[LogTarget::UiTimeline, LogTarget::SdkCommonDeserializedResponses]
            }
            TraceLogPacks::NotificationClient => &[LogTarget::UiNotificationClient],
            TraceLogPacks::SyncProfiling => &[
                LogTarget::MatrixSlidingSync,
                LogTarget::BaseSlidingSync,
                LogTarget::BaseResponseProcessors,
                LogTarget::Crypto,
                LogTarget::SdkCommonCrossProcessLock,
                LogTarget::SdkCommonDeserializedResponses,
            ],
            TraceLogPacks::LatestEvents => &[
                LogTarget::MatrixLatestEvents,
                LogTarget::MatrixSendQueue,
                LogTarget::MatrixEventCache,
            ],
            TraceLogPacks::Search => &[LogTarget::Search],
        }
    }
}
...
mod tests {
    ...
    fn test_default_tracing_filter() {
        ...
        assert_eq!(
            ...
            matrix::client=trace,
            crypto=debug,
            crypto::identities::manager=info,
            crypto::olm::account=trace,
            matrix::authentication::oauth=trace,
            matrix::http_client=debug,
            matrix::sliding_sync=info,
            base::sliding_sync=info,
            ui::timeline=info,
            matrix::send_queue=info,
            matrix::event_cache=info,
            matrix::latest_events=info,
            base::event_cache=info,
            sqlite::event_cache_store=info,
            sdk_common::cross_process_lock=warn,
            sdk_common::deserialized_responses=warn,
            base::store::ambiguity_map=warn,
            ui::notification_client=info,
            base::response_processors=info,
            search=info,
    ...
    fn test_trace_tracing_filter() {
        ...
        assert_eq!(
            ...
            matrix::client=trace,
            crypto=trace,
            crypto::identities::manager=trace,
            crypto::olm::account=trace,
            matrix::authentication::oauth=trace,
            matrix::http_client=trace,
            matrix::sliding_sync=trace,
            base::sliding_sync=trace,
            ui::timeline=trace,
            matrix::send_queue=trace,
            matrix::event_cache=trace,
            matrix::latest_events=trace,
            base::event_cache=trace,
            sqlite::event_cache_store=trace,
            sdk_common::cross_process_lock=warn,
            sdk_common::deserialized_responses=trace,
            base::store::ambiguity_map=warn,
            ui::notification_client=trace,
            base::response_processors=trace,
            search=trace,
