...
impl From<matrix::room_directory_search::RoomDescription> for RoomDescription {
    fn from(value: matrix::room_directory_search::RoomDescription) -> Self {
        Self {
...
impl From<VectorDiff<matrix::room_directory_search::RoomDescription>>
    for RoomDirectorySearchEntryUpdate
{
    fn from(diff: VectorDiff<matrix::room_directory_search::RoomDescription>) -> Self {
        match diff {
