...
impl From<crypto::store::SecretsBundleExportError> for SecretsBundleExportError {
    fn from(value: crypto::store::SecretsBundleExportError) -> Self {
        match value {
            ...
            crypto::store::SecretsBundleExportError::MissingBackupVersion => {
...
impl From<crypto::BootstrapCrossSigningError> for BootstrapCrossSigningError {
    fn from(err: crypto::BootstrapCrossSigningError) -> Self {
        use crypto::BootstrapCrossSigningError as BCSE;
        match err {
